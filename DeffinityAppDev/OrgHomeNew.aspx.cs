...
{
    public partial class OrgHomeNew1 : System.Web.UI.Page
    {
            ...
            try
            {
                if (Request.QueryString["orgguid"] != null)
                {
                    ...
                    if (orgEntity != null)
                    {
                        ...
                        himage.Value = Deffinity.systemdefaults.GetWebUrl() + "/wf/uploaddata/customers/portfolio_"+sessionKeys.PortfolioID+"_top.png";
