...
{
    public partial class FaithEducationList : System.Web.UI.Page
    {
        ...
        private void BindListView()
        {
            try
            {
                ...
                var elist = PortfolioMgt.BAL.FaithEducationDetailBAL.FaithEducationDetailBAL_SelectAll().Where(o=>o.OrganizationID == sessionKeys.PortfolioID);
