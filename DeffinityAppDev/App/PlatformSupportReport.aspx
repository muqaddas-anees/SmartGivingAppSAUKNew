...
<asp:Content ID="Content6" ContentPlaceHolderID="panel_options" runat="server">
    ...
    <asp:HyperLink ID="hBack" runat="server" NavigateUrl="~/App/Settings.aspx" Text="Back to Settings"></asp:HyperLink>
	...
	<div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" >
            ...
            <div class="card-toolbar gap-3" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="">
                 ...
                 <asp:Button ID="btnSend" runat="server" CssClass="btn btn-primary" Text="Send To Client" OnClick="btnSend_Click"  Visible="false"     />
