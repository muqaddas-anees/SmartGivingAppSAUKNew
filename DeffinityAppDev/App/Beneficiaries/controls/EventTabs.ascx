<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EventTabs.ascx.cs" Inherits="DeffinityAppDev.App.Events.controls.EventTabs1" %>
<div class="card mb-5 mb-xl-10">
    ...
    <li>  <a id ="link_return" href="~/WF/DC/FLSJlist.aspx?type=FLS" runat="server" target="_self"><i class="fa fa-arrow-left"></i> Return to  <%= Resources.DeffinityRes.ServiceDesk%></a></li>
            ...
            <asp:hiddenfield id="hidPortfolioID" runat="server" />
            <asp:hiddenfield id="hsdid" runat="server" value="0" />
        </div>
    </div>
</div>
