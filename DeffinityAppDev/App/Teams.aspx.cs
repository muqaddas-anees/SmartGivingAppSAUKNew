...
namespace DeffinityAppDev
{
    public partial class Teams : System.Web.UI.Page
    {
        ...
        private int GetPendingTasksCount(int userId)
        {
            ...
            using (var tasksContext = new PortfolioDataContext())
            {
                var tasks = tasksContext.Tasks.Where(t => t.currID == userId && t.StatusID == 1).ToList();
                //Where(t => t.currID == userId && t.StatusID == 1).ToList();
                return tasks.Count;
            }*/
            return 1;
        }
