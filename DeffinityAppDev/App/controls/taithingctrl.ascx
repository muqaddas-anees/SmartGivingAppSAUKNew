<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="taithingctrl.ascx.cs" Inherits="DeffinityAppDev.App.controls.taithingctrl" %>
								...
								<div  class="collapse show" style="">
									...
									<form id="kt_account_profile_details_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
										...
										<div class="card-body border-top p-9">
												...
												<!--begin::Col-->
												<div class="col-lg-8 fv-row fv-plugins-icon-container" style="margin-top:100px">
        ...
        <div style="width: 50%;  float: right;">
            	<!--begin::Input group-->
								...
								<div  class="collapse show" style="">
								 ...
								 <asp:Image ID="imgtop" runat="server" ImageUrl="~/assets/banners/cardconnect.png" Height="140px" />
								<%-- </div>--%>
												 
											 	<%--<i class="fa fa-cc-visa p-5" style="font-size:48px;color:blue" ></i> <i class="fa fa-cc-mastercard p-5" style="font-size:48px;color:blue"></i>  
												<i class="fa fa-cc-discover p-5" style="font-size:48px;color:blue"></i> <i class="fa fa-cc-diners-club p-5" style="font-size:48px;color:blue"></i>
											 	--%>
