<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FundraiserPayNewCtrl.ascx.cs" Inherits="DeffinityAppDev.App.controls.FundraiserPayNewCtrl" %>
...
<div class="row fs1 m-10 p-10"> test data</div>
         ...
         <div class="col-lg-4">
             ...
             <input type="text" runat="server" id="txtamount_list" class="form-control form-control-lg form-control-solid txtamt" style="text-align:right;font-size:22px" value="0" onkeyup="sum_amt();"   />
                                                           ...
                                                           <div class="row  mb-6 d-flex d-inline">
                                                                <div class="col-lg-12">
                                                       <asp:CheckBox ID="chkSelect" runat="server" Text=" " Font-Size="20px" CssClass="mycheckBig" ClientIDMode="Static" />
      ...
      <asp:Panel ID="pnlRecurringOption" runat="server" ClientIDMode="Static">
          <div class="row mb-6">
                                                        <asp:Label ID="Label5" runat="server" Text="How frequently would you like to donate?" Font-Bold="true" Font-Size="22px" ></asp:Label>
                                                              ...
                                                              <div class="row row-cols-1 row-cols-md-2 row-cols-lg-1 row-cols-xl-2 g-9 mb-6" data-kt-buttons="true" data-kt-buttons-target="[data-kt-button='true']"  id="spnl" runat="server" visible="false">
																<!--begin::Col-->
																<div class="col">
																	<!--begin::Option-->
             ...
             <div class="card-footer  py-3 px-5 mb-10">
                 <div class="row d-flex d-inline ">
                    ...
                    <asp:Button ID="btnNextUserInfo" runat="server" SkinID="btnNext" Height="60px" Width="120px" OnClick="btnNextUserInfo_Click" style="float:right" />
 ...
 <label class="col-lg-4 control-label">Phone number </label>
           <div class="col-lg-8">
               ...
               <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" 
                  ...
                  <asp:Button ID="btnNextToCardDetails" runat="server" SkinID="btnNext" Height="60px" Width="120px" OnClick="btnNextToCardDetails_Click" style="float:right" ValidationGroup="user" />
...
<script>
 ...
 <script type="text/javascript">
     ...
     function setFee() {
         var t = parseFloat($('#txtAmountTotal').val());
         var p = parseFloat($("#hfeepercent").val());
         var f = parseFloat($("#hplatformfeepercent").val());
         var x = parseFloat($("#hfixedamount").val());
         ...
         if (p > 0) {
             // t * (p / 100).toFixed(2)
             var r = Number(t * (p / 100).toFixed(2) + pr);

             r = r + x;
             //$('#txtAmountTotal').val(t + r);
             $('#hfee').val(t * (p / 100).toFixed(2));
