						...
						<%--	<div class="menu-item py-2">
							...
							<div class="menu-sub menu-sub-accordion menu-active-bg">
									...
									<%--<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
										...
										<div class="menu-sub menu-sub-accordion">
											<div class="menu-item">
												<a class="menu-link" href='<%:ResolveClientUrl("~/WF/CustomerAdmin/PortfolioContacts.aspx")%>'>
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
											...
											<div class="menu-item">
												<a class="menu-link" href='<%:ResolveClientUrl("~/WF/CustomerAdmin/ContactDetails.aspx")%>'>
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
									...
									<%--<div class="menu-item">
								<a href='<%:ResolveClientUrl("~/WF/DC/DashboardV2.aspx?tab=fls")%>' class="menu-link " title="Settings" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
									<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
													<span class="menu-title">Dashboard</span>
