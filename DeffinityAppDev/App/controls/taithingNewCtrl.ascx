...
<asp:HiddenField ID="currencySymbol" runat="server" Value="$" ClientIDMode="Static" />
                                                ...
                                                <hr />
                                                    ...
                                                    <asp:Panel ID="pnlCategory" runat="server">
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-lg-3  mb-3"><a href="#" onclick="return setmoney(20);"> <span class="badge badge-light-primary  money_cls"><%=Deffinity.Utility.GetCurrencySymbol() %>20</span></a></div>
<div class="col-lg-3  mb-3"><a href="#" onclick="return setmoney(50);"> <span class="badge badge-light-primary  money_cls"><%=Deffinity.Utility.GetCurrencySymbol() %>50</span></a> </div>
<div class="col-lg-3  mb-3"><a href="#" onclick="return setmoney(100);"> <span class="badge badge-light-primary  money_cls"><%=Deffinity.Utility.GetCurrencySymbol() %>100</span></a></div>
  ...
  <asp:Panel ID="pnlPaymentOptioin" runat="server">
      ...
      <div class="row" style="min-height:300px">
																...
																<div class="col">
																	...
																	<label class="btn btn-outline btn-outline-dashed btn-outline-default d-flex text-start p-6 active" data-kt-button="true">
																		...
																		<span class="form-check form-check-custom form-check-solid form-check-sm align-items-start mt-1">
																			<%--<input class="form-check-input" type="radio" name="discount_option" value="1"  runat="server" id="" >--%>
                                                                              <asp:RadioButton ID="chkonetime2" runat="server" CssClass="form-check-input" GroupName="discount_option" ClientIDMode="Static" />
																...
																<div class="col">
																	...
																	<label class="btn btn-outline btn-outline-dashed btn-outline-default d-flex text-start p-6" data-kt-button="true">
																		...
																		<span class="form-check form-check-custom form-check-solid form-check-sm align-items-start mt-1">
                                                                            ...
                                                                            <asp:RadioButton ID="chkRecurring" runat="server" CssClass="form-check-input" GroupName="discount_option" ClientIDMode="Static" />
																		</span>
        ...
        <div class="card-footer mb-10">
            <div class="row">
               <asp:Button ID="btnBackToCategory" runat="server" SkinID="btnDefault" Text="Back" Height="60px" Width="120px" OnClick="btnBackToCategory_Click" style="margin-right:50px" />
               <asp:Button ID="btnNextToPayAdvanced" runat="server" SkinID="btnNext" Height="60px" Width="120px" OnClick="btnNextToPayAdvanced_Click" style="float:right;" />
                                                        ...
                                                        <asp:Label ID="Label5" runat="server" Text="How frequently would you like to donate?" Font-Bold="true" Font-Size="22px" ></asp:Label>
                                                              ...
                                                              <div class="row row-cols-1 row-cols-md-2 row-cols-lg-1 row-cols-xl-2 g-9 mb-6" data-kt-buttons="true" data-kt-buttons-target="[data-kt-button='true']" id="spnl" runat="server">
																...
																<div class="col">
                                                                  ...
                                                                  <div class="col-lg-12">
                                                                      <asp:TextBox ID="txtStartDate" runat="server" SkinID="DateNew" ValidationGroup="date1"></asp:TextBox>
    ...
    ErrorMessage="Please enter the current date or a future date" Display="Dynamic" style="font-size:small" ValidationGroup="date1" />
             ...
             <div class="card-footer  py-3 px-5 mb-10">
                 <div class="row">
                     ...
                     <asp:Button ID="btnRecurringBack" runat="server" SkinID="btnDefault" Text="Back" Height="60px" Width="120px" OnClick="btnRecurringBack_Click"  style="margin-right:50px" />
                  
                     
                    <asp:Button ID="btnNextUserInfo" runat="server" SkinID="btnNext" Height="60px" Width="120px" OnClick="btnNextUserInfo_Click" ValidationGroup="date1" style="float:right" />
 ...
 <label class="col-lg-4 control-label">Phone Number </label>
           <div class="col-lg-8">
               ...
               <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" 
                      ...
                      <asp:Button ID="btnBackToOptions" runat="server" SkinID="btnDefault" Text="Back" Height="60px" Width="120px" OnClick="btnBackToOptions_Click"  style="margin-right:50px"/>
                  
                  <asp:Button ID="btnNextToCardDetails" runat="server" SkinID="btnDefault" Text="Pay Now" Height="60px" Width="120px" OnClick="btnNextToCardDetails_Click1" style="float:right" ValidationGroup="user" />
 ...
 <label class="col-lg-4 control-label">Card Number</label>
           <div class="col-lg-4">
               ...
               <div id="pnlCardConnect" runat="server" style="height:50px">
                    <asp:TextBox ID="txtCardConnectNumber" ClientIDMode="Static" runat="server" CssClass="paymentinfo-text" SkinID="txt_90"></asp:TextBox>
                  <%-- <iframe id="tokenframe" name="tokenframe"  
                       src="https://boltgw.cardconnect.com/itoke/ajax-tokenizer.html?css%3D%252Eerror%7Bcolor%3A%2520red%3B%7Dinput%7Bsize%3A30%3B%7D" 
                       frameborder="0" scrolling="no" width="200" height="30" runat="server"></iframe>--%>
 ...
 <label class="col-lg-4 control-label">Card Security Code</label>
           <div class="col-lg-8">
               ...
               <p>e.g: 123 </p>
                     ...
                     <asp:Button  ID="btnClose"  runat="server" SkinID="btnDefault" Text="Back" OnClientClick="" Height="60px" Width="120px" style="margin-right:50px" /> 
                  
                          
                   <asp:Button ID="btnProceed" runat="server" SkinID="btnDefault" Text="Pay Now" OnClick="btnProceed_Click" Height="60px" Width="120px"  style="float:right;" />
     ...
     <script type="text/javascript">
         ...
         function sum_amt() {
            ...
            // alert(add);
             ...
             $('#txtAmountTotal').val(add);
             $('#txtTotal').val(add);
             //$('#lblptotal').html(add.toFixed(2));
...
<script>
 ...
 <script type="text/javascript">
     ...
     $(document).ready(function () {
         var inputElement = document.getElementById('<%= lblplatfee.ClientID %>');
     ...
     function add25Percent(amount) {
         var percentage = (25 / 100) * amount;
         var totalAmount = amount + percentage;
         return totalAmount;
     }
     function setFee() {
         ...
         var pr = 0;
         var t_total = (t + (pval*t)/100).toFixed(2);
         $('#lblfee').html(pval);
         $('#hamount').val(t_total);
         ...
         $('#lblgtotal').html('£' + t);
         $('#lblgptotal').html('£' + add25Percent(parseInt(t) ));
