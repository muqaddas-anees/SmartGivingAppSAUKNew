...
<script type="text/javascript">
    ...
    var PercentageValue;
    var Total;
    window.addEventListener('message', function (event) F
                ...
                <div class="card-body p-0">
                    ...
                    <div class="row mb-6">
                        <div class="col-lg-12 col-sm-12 d-flex justify-content-center" style="text-align: center;">
                            ...
                            <br />
                            <br />
                            <asp:Label ID="lblMsgResult" runat="server" Text="Donation" Font-Bold="true" Font-Size="28px" ForeColor="#7239EA"></asp:Label>
                            <br />
...
<div class="row gy-5 g-xl-2 mb-6" id="pnlPrice" runat="server">
    ...
    <div class="col-xxl-12">
        ...
        <div id="donationsraised" style="margin: 5px;" class="card card-xxl-stretch">
            <!--begin::Header-->
            <div class="card-header border-0 py-5">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="row mb-6">
                        <div class="col-lg-8">
                            <asp:Label ID="lblDescription" runat="server" Text="Donation" Font-Bold="true" Font-Size="24px"></asp:Label>
                            <br />
...
<div class="col-lg-3  mb-3"><a href="#" onclick="return setmoney(100);"> <span class="badge badge-light-primary  money_cls">$100.00</span></a></div>--%>
                        ...
                        <div class="row mb-6">
                            <div class="col-lg-12 mr-3">
                                <label style="font-size: 20px">Words of Support</label>
                                <asp:TextBox
                                    runat="server"
                                    ID="txtSupport"
                                    ClientIDMode="Static"
                                    Font-Size="22px"
                                    CssClass="form-control-lg form-control"
                                    Width="100%">
                                </asp:TextBox>
                            </div>
                        </div>
  ...
  <div>  <span style="font-size:20px;font-weight: 500;"> Plegit does not charge <charity name> a fee, but we rely on your generous contribution to support the platform and help more people ❤️<br /></span></div>
     <div class="smaller-text">  <span class="smaller-text"> </span></div>
                                ...
                                <div class="slider-container">
                                    ...
                                    <asp:TextBox ID="lblplatfee" runat="server" CssClass="" Style="height: 10px; border-radius: 5px" TextMode="Range" Min="5" Max="30" Value="15" OnInput="updateSliderValue(this)" AutoPostBack="false"></asp:TextBox>
                                    <div class="dots"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row  mb-6" id="giftaid" runat="server">
                            <div class="col-lg-4 mb-6">
                                <div class="row  mb-6">
                                    <label class="form-label" style="font-size: 22px; margin-left: 5px; font-weight: bold">Turn
                                        <label id="lblgtotal"></label>
                                        into
                                        <label id="lblgptotal"></label>
                                        with Gift Aid  </label>
                                </div>
                                <div class="row  mb-6">
                        ...
                        <div class="row  mb-12 " style="display: none; visibility: hidden;">
                            <div class="col-lg-12 d-flex d-inline">
                                ...
                                <label style="font-size: 20px; margin-left: 5px;">Yes! I would like to cover the transaction fee and platform support cost of
                                    <lable id="lblfee" style="font-weight: bold;">0.00</lable>
                                    so that
                                    <asp:Label ID="lblOrg" runat="server"></asp:Label>
                                    can benefit from the full donation  </label>
                        ...
                        <div class="card-footer py-3 px-5 mb-10">
                            <div class="row d-flex justify-content-around">
                                ...
                                <div class="col-lg-3 text-center mt-5">
                                    ...
                                    <asp:Button ID="btnNextPaynow" runat="server" SkinID="btnDefault" Text="Pay right Now" CssClass="btn-responsive " OnClick="btnProceed_Click" Style="display: none;" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-footer mb-10">
                            <div class="row d-flex justify-content-around">
                                <div class="col-sm-3 mt-5">
                                    <asp:Button ID="btnBackToCategory" runat="server" CssClass="btn-responsive btn btn-primary" SkinID="btnDefault" Text="Back" Height="60px" Width="70%" OnClick="btnBackToCategory_Click" Style="margin-right: 50px" /></div>
                                <div class="col-sm-3  mt-5">
                                    <asp:Button ID="btnNextToPayAdvanced" runat="server" CssClass="btn-responsive btn btn-primary" SkinID="btnNext" Height="60px" Width="70%" OnClick="btnNextToPayAdvanced_Click" Style="float: right;" /></div>
                        ...
                        <div class="card-footer  py-3 px-5 mb-10">
                            <div class="row d-flex justify-content-around">
                                <div class="col-sm-5 mt-5">
                                    <asp:Button ID="btnRecurringBack" runat="server" CssClass="btn-responsive btn btn-primary" SkinID="btnDefault" Text="Back" Height="100%" Width="70%" OnClick="btnRecurringBack_Click" Style="margin-right: 50px" /></div>
                                <div class="col-sm-5 mt-5">
                                    <asp:Button ID="btnNextUserInfo" runat="server" CssClass="btn-responsive btn btn-primary" SkinID="btnNext" Height="60px" Width="70%" OnClick="btnNextUserInfo_Click" ValidationGroup="date1" Style="float: right" /></div>
                    ...
                    <asp:Panel ID="pnlnewCard" runat="server" ClientIDMode="Static">
                        ...
                        <div class="card-footer  py-3 px-5 mb-10">
                            <div class="row d-flex justify-content-around">
                                ...
                                <div class="col-sm-5 mt-5">
                                    <asp:Button ID="btnClose" runat="server" SkinID="btnDefault" Text="Back" OnClientClick="" Height="60px" Width="70%" Style="margin-right: 50px" />
                                </div>
                                <div class="col-sm-5 mt-5">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <div class="fs-4 fw-bolder">
                                                            ...
                                                            ****
                                                            <asp:Label ID="lblnumber" runat="server" Text='<%# Eval("CardNumbder") %>'></asp:Label>
                                                        </div>
                                                        <div class="fs-6 fw-bold text-gray-400">Card expires at
                                                            <asp:Label ID="lblmonth" runat="server" Text='<%# Eval("month") %>'></asp:Label>/<asp:Label ID="lblyear" runat="server" Text='<%# Eval("year") %>'></asp:Label></div>
                                                    </div>
                                                    <!--end::Details-->
                                                </div>
                                                <!--end::Wrapper-->
...
<%-- <div class="col-xxl-4">
                                  ...
                                  <div class="card mb-5 mb-xl-10" runat="server" id="wordsofsupportdiv" style="margin-left: 15px">
    <div class="card-body border-top p-9" style='background: #f5f5f5;'>
     
        <div class="row fs-2">
                            <div class="row mb-12 table-responsive">
<h4 class="fs-1">Words Of Support </h4>
      <div class="separator" style="margin:10px 0"></div>
                                </div>
                             <div class="row table-responsive">   
  <asp:Literal ID="wordsofsupportlit" runat="server" ClientIDMode="Static"></asp:Literal>
...
<script>
    ...
    const txtSupport = document.getElementById('<%= txtSupport.ClientID %>');

    // Set the initial value and style
    txtSupport.value = "Keep up the great work!";
    txtSupport.style.color = "grey"; // Set initial text color to grey

    // Add event listener for when the TextBox gains focus (is edited)
    txtSupport.addEventListener('focus', function () {
        // Check if the value is still the placeholder
        if (txtSupport.value === "Keep up the great work!") {
            txtSupport.value = ""; // Clear the placeholder
            txtSupport.style.color = "black"; // Change text color to black
        }
    });

    // Add event listener for when the TextBox loses focus
    txtSupport.addEventListener('blur', function () {
        // If the TextBox is empty, reset to the placeholder
        if (txtSupport.value === "") {
            txtSupport.value = "Keep up the great work!";
            txtSupport.style.color = "grey"; // Set back to grey
        }
    });
</script>
<script type="text/javascript">
