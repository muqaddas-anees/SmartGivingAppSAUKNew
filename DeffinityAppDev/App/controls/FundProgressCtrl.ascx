<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FundProgressCtrl.ascx.cs" Inherits="DeffinityAppDev.App.controls.FundProgressCtrl" %>
 <div class="card" id="pnl_progress" runat="server" visible="false">
