<%@ Page Title="" Language="C#" MasterPageFile="~/MasterTabSub.master" AutoEventWireup="true" CodeBehind="FLSDefault.aspx.cs" Inherits="DeffinityAppDev.App.FLSDefault" %>
...
<%@ Register Src="~/WF/DC/controls/FLSDocumentVisibilityCtrl.ascx" TagName="FLSDocumentVisibilityCtrl"
    TagPrefix="ucDoc" %>
<%@ Register Src="~/WF/DC/controls/Status.ascx" TagName="StatusCtrl" TagPrefix="Status" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="panel_options" runat="Server">
   ...
   <i class="bi bi-camera-video-fill btn-weight fs-4 me-2 btn-weight"></i> Video Tutorial</a>
      ...
      <asp:HyperLink ID="linkBack" runat="Server" NavigateUrl="~/App/Settings.aspx"><i class="fa fa-arrow-left"></i> Return to Settings</asp:HyperLink>
</asp:Content>
