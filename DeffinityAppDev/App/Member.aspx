    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer">
            ...
            <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="">
                ...
                <asp:HyperLink ID="btnBack" runat="server" NavigateUrl="~/App/users.aspx" CssClass="btn btn-light" Text="Back to Members"></asp:HyperLink>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
                ...
                <div class="card-body border-top p-9">
                    ...
                    <div class="row mb-6">
                        ...
                        <label class="col-lg-4 col-form-label fw-bold fs-6">
                            <asp:Label ID="lblSection" runat="server" Text="Member"></asp:Label>
                            Image</label>
                        <!--end::Label-->
                        <!--begin::Col-->
                        <div class="col-lg-8">
                            ...
                            <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url(assets/media/avatars/blank.png)">
                                ...
                                <div id="imageDiv" runat="server" class="image-input-wrapper w-125px h-125px" style="background-image: url(assets/media/avatars/150-26.jpg)">
                                    <asp:Image ID="img" runat="server" Height="100px" Visible="false" /></div>
                        ...
                        <div class="col-lg-8 fv-row fv-plugins-icon-container d=flex d-inline">
                            ...
                            <asp:Panel ID="Panel_portfolio" ClientIDMode="Static" runat="server" Width="50%" CssClass="card shadow-sm">
                                <div class="card-header">
                                    <h3 class="card-body">
                                        <asp:Label ID="lblOptions" runat="server" Text="Add Company"></asp:Label>
                                    </h3>
...
<ContentTemplate>--%>
                                    <div class="modal-body">
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-lg-9">
                                                <asp:TextBox ID="txtAddCompany" runat="server" SkinID="txt_90"></asp:TextBox>
                                        ...
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-lg-9">
                                                <asp:TextBox ID="txtCompanyEmail" runat="server" SkinID="txt_90"></asp:TextBox></div>

                                        </div>
                                        <div class="row mb-6">
                                            <label class="col-lg-3 col-form-label fw-bold fs-6">Phone number </label>
                                            <div class="col-lg-9">
                                                <asp:TextBox ID="txtCompanyPhone" runat="server" SkinID="txt_90"></asp:TextBox></div>

                                        </div>
                                        <div class="row mb-6">
                                            <label class="col-lg-3 col-form-label fw-bold fs-6">Address </label>
                                            <div class="col-lg-9">
                                                <asp:TextBox ID="txtCompanyAddress" runat="server" SkinID="txtMulti_80" TextMode="MultiLine"></asp:TextBox></div>

                                        </div>
                                        <div class="row mb-6">
                                            <label class="col-lg-3 col-form-label fw-bold fs-6">Notes </label>
                                            <div class="col-lg-9">
                                                <asp:TextBox ID="txtCompanyNotes" runat="server" SkinID="txtMulti_80" TextMode="MultiLine"></asp:TextBox></div>
    ...
    <div class="card mb-5 mb-xl-10" id="pnlCustomfields" runat="server">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_deactivate" aria-expanded="true" aria-controls="kt_account_deactivate">
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">Additional information
                    <asp:Label ID="lblCustomFiledCustomer" runat="server" Visible="false"></asp:Label></h3>
            </div>
        </div>
               ...
               <div class="row">
                   <div class="col-lg-8">
                       <%--<input class="form-control" value="tag1, tag2, tag3" id="kt_tagify_1"/>--%>
                          <div class="card mb-5 mb-xl-10" id="Div3" runat="server">
       <!--begin::Card header-->
       <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_deactivate" aria-expanded="true" aria-controls="kt_account_deactivate">
           <div class="card-title m-0">
...
<div class="form-check mt-2">
    ...
    <label style="margin-left:8px" class="" for="chkMembers">Members</label>
</div>                       <%--<​input name="input-custom-dropdown" class="form-control" placeholder="write some tags" value="css, html, javascript"/>--%>
                   </div>
               </div>
       ...
       <!--end::Content-->
           ...
           <!--begin::Card footer-->
           <div class="card-footer d-flex justify-content-end py-6 px-9">
               <asp:Button ID="Button3" runat="server" CausesValidation="false" OnClick="btnUpdateSkill_Click" Text="Update" />
    ...
    <asp:Panel ID="pnlManagePassword" runat="server" BackColor="White" Style="display: none;"
        ...
        <div class="card-header">
            <div class="card-title">
                ...
                <h3 class="card-label">
                    <asp:Label ID="Label2" runat="server" Text="Mail Details"></asp:Label>
                </h3>
            </div>
        ...
        <div class="card-body">
            ...
            <div class="form-group row mb-6">
                <div class="col-md-12 form-inline">
                    ...
                    <asp:HiddenField ID="htomail" runat="server" />
