...
{
    public class TakepaymentsGateway
    {
        ...
        public TakepaymentsGateway(string mid,string sid)
        {
            this.merchantID = mid;// "119837";//ConfigurationManager.AppSettings.Get("merchantID");
            this.merchantSecret = sid;// "9GXwHNVC87VqsqNM";//ConfigurationManager.AppSettings.Get("merchantKey");
            this.directUrl = ConfigurationManager.AppSettings.Get("directUrl");
            this.hostedUrl = ConfigurationManager.AppSettings.Get("hostedUrl");
            this.proxyUrl = null;
        }
            ...
            Dictionary<string, string> options = null)
        {
                    ...
                    new HttpMethod("POST"), directUrl))
            {
                ...
                LogExceptions.LogException(resultString);
