<%@ Page Title="" Language="C#" MasterPageFile="~/MainTab.master" AutoEventWireup="true" CodeBehind="Members.aspx.cs" Inherits="DeffinityAppDev.App.Members" %>

<%@ Register Src="~/App/controls/MembersTab.ascx" TagPrefix="Pref" TagName="MembersTab" %>
                                             ...
                                             <div class="col-lg-5 fv-row fv-plugins-icon-container" >
                                             	...
                                             	<div class="col-lg-2 fv-row fv-plugins-icon-container" style="padding-top:40px">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-2 fv-row fv-plugins-icon-container form-inline mt-5" style="display:inline;">
                                                            
                                                         <asp:CheckBox ID="chk_show" runat="server" OnCheckedChanged="chk_show_CheckedChanged" ClientIDMode="Static" Checked="true" Text="Show Active Users" AutoPostBack="true" CssClass="big-checkbox fs-4" />
        ...
        <Columns>
             ...
             <asp:TemplateField ItemStyle-Width="9px" >
              ...
              <asp:TemplateField HeaderText="Name" SortExpression="Organization">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblInstance" runat="server" Text='<%# Bind("Name") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
