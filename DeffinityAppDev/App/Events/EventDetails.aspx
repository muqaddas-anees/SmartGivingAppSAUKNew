					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<asp:ListView runat="server" ID="ListEventDetails" GroupPlaceholderID="groupplaceholder" ItemPlaceholderID="itemplaceholder">
											...
											<div class="flex-column flex-lg-row-auto w-100 w-xl-300px mb-10">
												...
												<div class="mb-16">
													...
													<div class="d-flex flex-stack fw-bold fs-5 text-muted mb-4">
														...
														<!--end::Text-->
														<!--begin::Number-->
														<div class="m-0"><%# Eval("StartDateTime","{0:dd/MM/yyyy hh:mm tt}") %></div>
														<!--end::Number-->
													</div>
													...
													<div class="d-flex flex-stack fw-bold fs-5 text-muted mb-4">
														...
														<!--end::Text-->
														<!--begin::Number-->
														<div class="m-0"><%# Eval("EndDateTime" ,"{0:dd/MM/yyyy hh:mm tt}") %></div>
														<!--end::Number-->
													</div>
												...
												<!--end::Catigories-->
												<asp:Button ID="btnGetUrl" runat="server" CssClass="btn btn-light btn-lg btn-block w-100" Text="Get URL" OnClick="btnGetUrl_Click" Visible="false" />
										...
										<!--end::Section-->
											...
											<div class="fs-5 fw-bold text-gray-600 col-lg-12">
