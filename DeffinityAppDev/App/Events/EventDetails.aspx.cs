    ...
    public partial class EventDetails : System.Web.UI.Page
    {
        ...
        protected void btnBookTickets_Click(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["unid"] != null)
            {
                ...
                Response.Redirect("~/App/Events/ManageTickets.aspx?unid=" + id,false);
            }
        }
        ...
        {
            string url = "";
            WebRequest request = WebRequest.Create("https://www.googleapis.com/urlshortener/v1/url?key=AIzaSyC5fVno1A77Hcx9XMr5k070Nm9TwFPEYuM");
            request.Method = "POST";
