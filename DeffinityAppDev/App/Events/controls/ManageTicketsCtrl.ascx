<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ManageTicketsCtrl.ascx.cs" Inherits="DeffinityAppDev.App.Events.controls.ManageTicketsCtrl" %>
    ...
    <div class="row mb-4" style="display:none;" id='<%# Eval("ID").ToString() %>'>
         ...
         <div class="col-lg-4">
                ...
                <asp:ListItem Value="Zimbabwe">Zimbabwe</asp:ListItem>
                                                                     ...
                                                                     <div class="col-lg-12">
                                                                           <label for="email">Company:</label>
                                                                          <asp:TextBox ID="txtCompany" runat="server" MaxLength="250"  Text='<%# Eval("Company") %>'></asp:TextBox>
                                                                         </div>
                                                                     </div>
...
<div class="row d-flex justify-content-center"> <asp:Button ID="btnProceed" runat="server" SkinID="btnDefault" Text="Pay Now" OnClick="btnProceed_Click" Height="60px" Width="60%" /> </div>
                                                          </asp:Panel>
 ...
 <script src='<%:ResolveClientUrl("~/Scripts/bootstrap-input-spinner.js")%>' type="text/javascript"></script>
