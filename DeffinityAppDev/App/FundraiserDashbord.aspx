<%@ Page Title="" Language="C#" MasterPageFile="~/MasterTabSub.master" AutoEventWireup="true" CodeBehind="FundraiserDashbord.aspx.cs" Inherits="DeffinityAppDev.App.FaithGivingDashbord" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="MainContent" runat="server">
							...
							<div class="card">
								...
								<div class="card-body p-0">
									...
									<div class="card-px text-center py-20 my-10">
										...
										<!--end::Description-->
										<!--begin::Action-->
										<asp:HyperLink ID="btnBuilder" runat="server" CssClass="btn btn-primary" Text="Let’s Set Up Your Fundraiser now" NavigateUrl="~/App/AddFundraiser.aspx?type=main"  ></asp:HyperLink>
    ...
    <div class="row gy-5 g-xl-10" id="pnlFunriserlist" runat="server">
								<!--begin::Col-->
								<div class="col-xl-4">
        ...
        <asp:GridView ID="GridDashboard" runat="server" Width="100%">
            <Columns>
                <asp:TemplateField Visible="false">
                 ...
                 <asp:TemplateField HeaderText="Amount" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="150px">
                    <ItemTemplate>
