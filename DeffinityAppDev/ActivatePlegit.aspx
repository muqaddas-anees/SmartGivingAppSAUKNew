<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActivatePlegit.aspx.cs" Inherits="DeffinityAppDev.ActivatePlegit" %>
...
<body id="kt_body" class=" bg-body">
	...
	<link href='<%:ResolveClientUrl("~/assets/plugins/custom/leaflet/leaflet.bundle.css")%>' rel="stylesheet" type="text/css" >
					...
					<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						...
						<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="#" runat="server">
							...
							<div class="text-center mb-10">
								<!--begin::Title-->
								<h1 class="text-dark mb-3">You've been invited by <asp:Label ID="lblFunriaser_title" runat="server"></asp:Label> to join their <asp:Label ID="lblInstance" runat="server"></asp:Label> campaign 

									<p> Create your <asp:Label ID="lblInstance1" runat="server"></asp:Label> account to start fundraising </p>
								</h1>
								<!--end::Title-->
								<!--begin::Link-->
							...
							<!--begin::Input group-->
								...
								<asp:TextBox ClientIDMode="Static" ID="txtemail" CssClass="form-control" runat="server" AutoCompleteType="Disabled" ReadOnly="true" > </asp:TextBox>
                        <%--<asp:RequiredFieldValidator  style="font-size:small" ID="RequiredFieldValidator1" Display="Dynamic" runat="server" ForeColor="Red" ErrorMessage="Please enter Username" ControlToValidate="txtusername" ValidationGroup="group1" ></asp:RequiredFieldValidator>--%>
								<!--end::Input-->
							</div>
							<div class="fv-row mb-10">
								<!--begin::Label-->
								...
								<!--begin::Input-->
								<%--<input class="form-control form-control-lg form-control-solid" type="text" name="email" autocomplete="off" />--%>
								<asp:TextBox ClientIDMode="Static" ID="txtname" CssClass="form-control" runat="server" AutoCompleteType="Disabled" ReadOnly="true" > </asp:TextBox>
                       <%-- <asp:RequiredFieldValidator  style="font-size:small" ID="Rfv1" Display="Dynamic" runat="server" ForeColor="Red" ErrorMessage="Please enter Username" ControlToValidate="txtusername" ValidationGroup="group1" ></asp:RequiredFieldValidator>--%>
								<!--end::Input-->
							</div>
							<!--end::Input group-->
							<!--begin::Input group-->
							<div class="fv-row mb-10" id="pnl_password" runat="server">
								<!--begin::Wrapper-->
				  ...
				  <div id="password-conditions">
                    ...
                    <div class="condition" id="special-char-condition">
                        <span class="icon">&#10060;</span> One special character
								...
								<div class="fv-row mb-10"  id="pnl_confirmpassword" runat="server">
								<!--begin::Wrapper-->
								<div class="d-flex flex-stack mb-2">
									<!--begin::Label-->
		...
		<%-- <asp:RequiredFieldValidator style="font-size:small" ID="RequiredFieldValidator1" Display="Dynamic" runat="server" ForeColor="Red" 
			 ErrorMessage="Please enter Password" ControlToValidate="txtPwd" ValidationGroup="group1"></asp:RequiredFieldValidator>--%>
				 ...
				 <asp:CompareValidator ID="comparePasswords" runat="server" ControlToCompare="txtpwd" style="font-size:small"
							...
							<div class="text-center">
								...
								<button type="submit" id="kt_sign_in_submit" class="btn btn-lg btn-primary w-100 mb-5" style="display:none;visibility:hidden;">
								 ...
								 <asp:Button ID="btnsubmit" runat="server" SkinID="btnSubmit" OnClick="btnsubmit_Click" ValidationGroup="group1" Text="Signup" TabIndex="0" Width="95%" disabled></asp:Button>
								 <asp:Button ID="btnSubmit1" runat="server" SkinID="btnSubmit" OnClick="btnsubmit_Click" ValidationGroup="group1" Text="Signup" TabIndex="0" Width="95%"  Visible="false"></asp:Button>
