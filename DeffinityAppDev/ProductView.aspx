<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductView.aspx.cs" Inherits="DeffinityAppDev.ProductView" %>

<%@ Register Src="~/App/controls/ProductDetailsCtrl.ascx" TagPrefix="Pref" TagName="FaithGivingListCtrl" %>
...
<body>
    ...
    <form id="form1" runat="server">
			...
			<body id="kt_body" class="page-loading-enabled page-loading header-fixed header-tablet-and-mobile-fixed aside-enabled aside-fixed" style="">
		<!--begin::Main-->
