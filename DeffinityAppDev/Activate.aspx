<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Activate.aspx.cs" Inherits="DeffinityAppDev.Activate" %>
					...
					<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						...
						<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="#" runat="server">
							...
							<div class="text-center mb-10">
								<!--begin::Title-->
								<h1 class="text-dark mb-3"><asp:Label ID="lblFunriaser_title" runat="server" Visible="false"></asp:Label><asp:Label ID="lblInstance" runat="server" Visible="false"></asp:Label>

									<p> <asp:Label ID="lblInstance1" runat="server"></asp:Label> fill the following details to complete the registration process </p>
								</h1>
								<!--end::Title-->
								<!--begin::Link-->
                       ...
                       <%-- <asp:RequiredFieldValidator  style="font-size:small" ID="Rfv1" Display="Dynamic" runat="server" ForeColor="Red" ErrorMessage="Please enter Username" ControlToValidate="txtusername" ValidationGroup="group1" ></asp:RequiredFieldValidator>--%>
							...
							<div class="fv-row mb-10">
								...
								<!--begin::Input-->
								<%--<input class="form-control form-control-lg form-control-solid" type="text" name="email" autocomplete="off" />--%>
								<asp:TextBox ClientIDMode="Static" ID="txtLastname" CssClass="form-control" runat="server" AutoCompleteType="Disabled" > </asp:TextBox>
                       <%-- <asp:RequiredFieldValidator  style="font-size:small" ID="Rfv1" Display="Dynamic" runat="server" ForeColor="Red" ErrorMessage="Please enter Username" ControlToValidate="txtusername" ValidationGroup="group1" ></asp:RequiredFieldValidator>--%>
								<!--end::Input-->
							</div>
							<!--end::Input group-->
				 ...
				 <asp:CompareValidator ID="comparePasswords" runat="server" ControlToCompare="txtpwd" style="font-size:small"
							...
							<div class="text-center">
								<!--begin::Submit button-->
								 ...
								 <asp:Button ID="btnsubmit" runat="server" SkinID="btnSubmit" OnClick="btnsubmit_Click" ValidationGroup="group1" Text="Submit" TabIndex="0" Width="95%" disabled></asp:Button>
