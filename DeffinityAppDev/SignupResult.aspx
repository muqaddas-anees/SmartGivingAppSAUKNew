<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignupResult.aspx.cs" Inherits="DeffinityAppDev.SignupResult" %>
									...
									<div class="text-center mb-5">
											...
											<!--begin::Overlay-->
												...
												<div class="row mb-6" id="pnlFist" runat="server">
													...
													<div class="row mb-0 text-center" style="padding-bottom:10px;">
														<p>
														</p>

														
													</div>
													<div class="row text-center pt-25">
														
														<asp:Label ID="lblResult" runat="server" Text="" Font-Size="22px"></asp:Label>
														<br /><br />

													</div>
														<div class="row mb-6  text-center pt-10">
