...
public partial class HealthCheckSchedule : System.Web.UI.Page
{
    ...
    protected void ImageButton1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            healthCheckList.iSChecklist = true;
    ...
    void SendMail(int portfolioHealthCheckID,int healthCheckID,int selectedRow,ArrayList mailIDs)
    {
        ...
        if (mailIDs.Count > 0)
        {
            ...
            string htmlTest = htmlHiJacker.RetrieveBodyFromAnotherPage(@ConfigurationManager.AppSettings["LocalUrl"].ToString() + "/WF/Health/MailTemplates/HealthCheckDetails.aspx?healthcheckid=" + healthCheckID + "&PortfolioID=" + sessionKeys.PortfolioID, ref errorString);
    ...
    protected void gridHealthChecks_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
    {
        ...
        else
        {
            ...
            lblErrorMessage.Text = "Mail was sent successfully";
