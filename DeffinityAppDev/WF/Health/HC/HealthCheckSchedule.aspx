<%@ Page Language="C#" MasterPageFile="~/WF/MainTab.master" AutoEventWireup="true" Inherits="HC_HealthCheckSchedule" Title="Health Check Schedule" EnableEventValidation="false" Codebehind="HealthCheckSchedule.aspx.cs" %>
...
<%@ Register Src="~/WF/Health/controls/HealthCheckCtrl.ascx" TagName="HealthCheckCtrl" TagPrefix="uc2" %>
   ...
   <%-- <script src="../Scripts/jquery-1.9.0.min.js" type="text/javascript"></script>--%>
    <script type="text/javascript">
        $(document).ready(function () {
            $('.tabs_list4 li:eq(1)').addClass('current1');
        });
    </script>
    <script type="text/javascript">
        ...
        function checkAll(checkbox) {
            ...
            var gvInner = document.getElementById(innerGridId + "gridInner");
    ...
    <uc2:HealthCheckCtrl ID="HealthCheckCtrl1" runat="server" Visible="true" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="Server">
    <asp:Panel ID="pnlSearch" runat="server">
        <div class="form-group">
         <div class="col-md-4">
           ...
           <div class="col-sm-8">
               <asp:DropDownList ID="ddlPortfolio" runat="server" AppendDataBoundItems="true" AutoPostBack="true"
	...
	<div class="col-md-4">
           <label class="col-sm-4 control-label"> <asp:Label ID="lblHealthCheckTitle" runat="server" Text='<%$ Resources:DeffinityRes,Forms%>'></asp:Label></label>
           <div class="col-sm-8">
                <asp:DropDownList ID="ddlHealthCheckTitle" runat="server" >
                                    </asp:DropDownList>
                                    <%--  <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="objHealthCheckDDLFiller"
                                   ...
                                   <%-- <asp:ObjectDataSource ID="objHealthCheckDDLFiller" runat="server" TypeName="DataHelperClass"
                                      ...
                                      <ajaxToolkit:CascadingDropDown ID="ccdForms" runat="server" TargetControlID="ddlHealthCheckTitle"
                                Category="SubName" PromptText="Please select..." PromptValue="0" ServicePath="~/WF/Health/HC/HCWebService.asmx"
	...
	<div class="col-md-4">
           ...
           <div class="col-sm-8 form-inline">
                <asp:TextBox ID="txtDate" runat="server" SkinID="Date" MaxLength="10"></asp:TextBox>
                                    <asp:Image ID="imgCalendar" runat="server" SkinID="Calender" />
	...
	<div class="col-md-4">
     ...
     <div class="form-group">
            ...
            <ContentTemplate>--%>
                    <asp:GridView ID="gridHealthChecks" runat="server" DataSourceID="objGridFiller" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Report" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink2" SkinID="LinkPrint" ToolTip="Report"
                                        runat="server" NavigateUrl='<%#"~/WF/Health/HC/Print.ashx?HealthCheckID="+ Eval("ID").ToString()%>'
                                        Target="_self" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Form" ItemStyle-HorizontalAlign="Center" SortExpression="HealthCheckTitle">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                     <asp:Label SkinID="Mail" ID="imgPopUp" runat="server" ></asp:Label>
          ...
          <div class="col-md-12 pull-right">
                    <asp:Button ID="btnUpdate" runat="server" SkinID="btnUpdate" OnClick="btnUpdate_Click" Visible="false" />
                </div>
                   </div>
    <script  type="text/javascript">
        $(document).ready(function () {
