<%@ Page Title="" Language="C#" MasterPageFile="~/WF/MainFrame.Master" AutoEventWireup="true" CodeBehind="FormPreviewNew.aspx.cs" Inherits="DeffinityAppDev.WF.Health.HC.FormPreviewNew" %>
...
.modal {
    ...
    <div class="form-group row">
          <a id="A1" href="~/WF/Health/HC/FormList.aspx" runat="server"
            target="_self" class="btn btn-black" style="float:right;"><i class="fa fa-arrow-left"></i> Return to Forms List</a>
    </div>
     <div class="form-group row">
         <div id="loading">
...
<script>
         ...
         <script>
             ...
             function StartTimeJob(jobid, hour, minute, second, status) {
                 try {
                     ...
                     $.ajax({
                         type: "POST",
                         url: "../../DC/Services/AdminServices.asmx/StartTimeJob",
                         data: dataObject,
             ...
             function GetHVACData(jobid) {
                 try {
                     ...
                     $.ajax({
                         url: "../../DC/Services/AdminServices.asmx/BindHVACData",
                         type: "POST",
                         data: dataObject,
                         contentType: 'application/json; charset=utf-8',
                         dataType: "json",
    ...
    <script type="text/javascript">
        ...
        function applyService(serviceid,jobid) {
            ...
            $.ajax({
                type: "POST",
                url: "../../DC/Services/AdminServices.asmx/ApplyServicetoJob",
                data: dataObject,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
    ...
    <script type="text/javascript">
        ...
        function AddFormData() {
            var id = $("[id*=hfdid]").val();
            var subid = "0";// $("[id*=ddlSubCategory]").val();
            ...
            $.ajax({
                type: "POST",
                url: "../../DC/Services/AdminServices.asmx/FromDataAdd",
                data: dataObject,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
        ...
        function deleteFormDatabyMethod() {
            ...
            $.ajax({
                type: "POST",
                url: "../../DC/Services/AdminServices.asmx/FromDataDelete",
                data: dataObject,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
        ...
        function UpdateFormData() {
            ...
            $.ajax({
                type: "POST",
                url: "../../DC/Services/AdminServices.asmx/CategoryUpdate",
                data: dataObject,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
    ...
    <script type="text/javascript">
        ...
        function SetServiceContactData() {
            var category = "0"//$("[id*=ddlSubCategory]").val();
            if (category == null)
                category = "0";
            else if (category == "")
                category = "0";
            ...
            if (category != "0") {
                $.ajax({
                    type: "POST",
                    url: "../../DC/Services/AdminServices.asmx/ServiceGet",
        ...
        function AddServiceContactData() {
            //var id = $("[id$='hcid']").val();
            var subcategory = "0";// $("[id*=ddlSubCategory]").val();
            ...
            $.ajax({
                type: "POST",
                url: "../../DC/Services/AdminServices.asmx/ServiceAdd",
                data: dataObject,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
        ...
        function UpdateServiceContactData() {
            ...
            $.ajax({
                type: "POST",
                url: "../../DC/Services/AdminServices.asmx/ServiceUpdate",
                data: dataObject,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
        ...
        function DeleteServiceContactData() {
            ...
            $.ajax({
                type: "POST",
                url: "../../DC/Services/AdminServices.asmx/ServiceDelete",
                data: dataObject,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
     ...
     <div class="row" >
    <div class="col-md-10">
        <div style="text-align:right;"> <asp:Button ID="btnSave" runat="server" SkinID="btnDefault" Text="Save Changes" ClientIDMode="Static" style="float:right;display:none;" /> </div>
   ...
   <script type="text/javascript">
       ...
       function GetFormDatabyID(id) {
           ...
           try {
               $.ajax({
                   url: "../../DC/Services/AdminServices.asmx/BindFromDataByID",
                   type: "POST",
                   data: "{'id': '" + id + "'}",
                   contentType: 'application/json; charset=utf-8',
                   dataType: "json",
       ...
       function GetFormData(jobid) {
           ...
           try {
               ...
               $.ajax({
                   url: "../../DC/Services/AdminServices.asmx/BindFromDataByFormAndJobID",
                   type: "POST",
                   data: dataObject,
                   contentType: 'application/json; charset=utf-8',
                   dataType: "json",
                       ...
                       for (var i = 0; i < NewData.length; i++) {
                          ...
                          // setServiceDropdownValue();
                           ...
                           if (TypeOfField == "Subheading") {
                               x = x + "<div class='form-group'><div class='col-md-12 text-bold'> <strong>" + LabelName+"</strong><hr class='no-top-margin' /></div></div>";
                           }
                               else {
                               x = x + "<div class='form-group' ><div class='col-md-12' style='padding-bottom:15px'>";

                               x = x + "<label class='col-sm-2 control-label' style='text-align:right;'>" + LabelName + "</label>";
                               x = x + "<div class='col-sm-8'>" + DisplayValues(ListValue, TypeOfField, ID, ListValueValues, ListNotesValues) + "</div>"
                               x = x + "</div>";
                               x = x + "</div>";
                           }
                       }
       ...
       function deleteFile(id) {
           ...
           $.ajax({
               url: "../../DC/Services/AdminServices.asmx/DeleteFile",
               type: "POST",
               data: data,
               contentType: false,
               processData: false,
       ...
       function uploadfile(id) {
           ...
           $.ajax({
               url: "../../DC/Services/AdminServices.asmx/UploadFile",
               type: "POST",
               data: data,
               contentType: false,
               processData: false,
       ...
       function saveData() {
          ...
          // return d;
           ...
           $.ajax({
               type: "POST",
               url: "../../DC/Services/AdminServices.asmx/JobUpdateData",
               data: dataObject,
               contentType: "application/json; charset=utf-8",
               dataType: "json",
               async: false,
