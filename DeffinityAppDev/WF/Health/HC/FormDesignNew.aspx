<%@ Page Title="" Language="C#" MasterPageFile="~/WF/MainTab.master" AutoEventWireup="true" CodeBehind="FormDesignNew.aspx.cs" Inherits="DeffinityAppDev.WF.Health.HC.FormDesignNew" EnableEventValidation="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="panel_options" runat="Server">
   <a id="A1" href="~/WF/Health/HC/FormList.aspx" runat="server"
            target="_self"><i class="fa fa-arrow-left"></i> Return to Forms List</a>
</asp:Content>
         ...
         <script>
                ...
                // $('[id*=pnllist]').empty();
                 ...
                 $('[id*=ddlService] > option').each(function () {
                     if ($(this).val() != "0") {
                         ...
                         var pnlid = $(this).val();
                         b = b + "<div class='pnllist'>"
                         b = b + "<div class='form-group'>";
                         b = b + "<div class='col-md-12' style='border-bottom: 2px solid #f5f5f5;'>";
                         b = b + " <div class='col-sm-6 '></div>";
                         b = b + "<label class='col-sm-6 control-label lblpnl' style='width:100%'>" + $(this).text(); +"</label> ";
                         b = b + " <input type='submit' value='Add Controls'  class='btn btn-secondary' style='float:right;' onclick='showAddFormControls(" + pnlid+");return false;' />";
                         b = b + " <input type='hidden' class='hpnl' value='" + pnlid + "' /> ";
             ...
             function GetFormDataNew(id) {
                 try {
                     ...
                     $.ajax({
                         url: "Services/FormsServices.asmx/BindFromData",
                         type: "POST",
                         data: "{'id': '" + id + "'}",
...
<script>
      ...
      <div class="col-md-10">
          ...
          <div class="col-sm-10 form-inline">
            <asp:DropDownList ID="ddlForm" CssClass="ddl1" runat="server" ClientIDMode="Static" SkinID="ddl_70"></asp:DropDownList>
              ...
              <asp:LinkButton ID="btnDelSubCategory" runat="server" SkinID="BtnLinkDelete" ClientIDMode="Static" OnClientClick="return confirm('Do you want to delete the form?');"></asp:LinkButton>
              </div>
          </div>
        </div>
     <div class="form-group row">
    ...
    <script type="text/javascript">
        ...
        function deleteFormDatabyMethod() {
            ...
            $.ajax({
                type: "POST",
                url: "Services/FormsServices.asmx/FromDataDelete",
                data: dataObject,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
        ...
        function UpdateFormData() {
            ...
            $.ajax({
                type: "POST",
                url: "Services/FormsServices.asmx/CategoryUpdate",
                data: dataObject,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
    ...
    <script type="text/javascript">
        ...
        function SetCategoryContactData() {
            ...
            if (id != "0") {
                $.ajax({
                    type: "POST",
                    url: "Services/FormsServices.asmx/CategoryGet",
                    data: "{typeid:'" + id + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    async: false,
        ...
        function AddCategoryContactData() {
            ...
            $.ajax({
                type: "POST",
                url: "Services/FormsServices.asmx/CategoryAdd",
                data: dataObject,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
        ...
        function DeleteCategoryContactData() {
            ...
            $.ajax({
                type: "POST",
                url: "Services/FormsServices.asmx/CategoryDelete",
                data: dataObject,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                //async: false,
    ...
    <script type="text/javascript">
        ...
        function SetSubCategoryContactData() {
            ...
            if (category != "0") {
                $.ajax({
                    type: "POST",
                    url: "Services/FormsServices.asmx/FormGet",
        ...
        function AddSubCategoryContactData() {
            ...
            $.ajax({
                type: "POST",
                url: "Services/FormsServices.asmx/FormAdd",
                data: dataObject,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
    ...
    <script type="text/javascript">
        ...
        function SetServiceContactData() {
            ...
            if (category != "0") {
                $.ajax({
                    type: "POST",
                    url: "Services/FormsServices.asmx/FormPanelGet",
                    data: "{category:'" + category + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    async: false,
        ...
        function DeleteServiceContactData() {
            ...
            $.ajax({
                type: "POST",
                url: "Services/FormsServices.asmx/FormPanelDelete",
                data: dataObject,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
...
<asp:Content ID="Content7" ContentPlaceHolderID="Scripts_Section" runat="Server">
    ...
    <script>
       ...
       // applyDatePicker();
        ...
        //    //$('#pnlroot').append(formtitlepnl());

        //});

        //function formtitlepnl() {
        //    var retval = "";

        //    retval = retval + "<div class='form-group'> <div class='col-md-12'>";
        //    retval = retval + "test";
