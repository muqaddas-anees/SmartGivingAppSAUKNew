<%@ Page Language="C#" AutoEventWireup="true"
    Culture="en-GB" Inherits="MailTemplates_HealthCheckListItem" EnableViewState="false" EnableTheming="false" Codebehind="HealthCheckListItem.aspx.cs" %>
...
<body>
    ...
    <div>
        ...
        <asp:DetailsView ID="DetailsView1" runat="server" CellPadding="4" DataSourceID="objHealthCheckList"
            ...
            <Fields>
                ...
                <asp:TemplateField HeaderText="Date Raised">
                    <ItemTemplate>
                        <asp:Label ID="lblDateRaised" runat="server" Text='<%#Eval("DateRaised","{0:d}")%>' />
                    </ItemTemplate>
                </asp:TemplateField>
        ...
        <br />
        <br />
        <asp:GridView ID="gridHealthCheckListItems" Width="100%"
            runat="server" CellPadding="4" EnableTheming="False" ForeColor="#333333" GridLines="Vertical" AutoGenerateColumns="false">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Date Completed">
                    <ItemTemplate>
                        <asp:Literal ID="litDateCompleted" runat="server" Text='<%#Convert.ToDateTime(Eval("DateCompleted").ToString()).ToShortDateString()%>' />
                    </ItemTemplate>
                </asp:TemplateField>
