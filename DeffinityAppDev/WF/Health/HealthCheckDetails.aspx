<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HealthCheckDetails.aspx.cs"
    Culture="en-GB" Inherits="MailTemplates_HealthCheckDetails" EnableViewState="false" %>
...
<body>
    ...
    <div>
        ...
        <br />
        <br />
        <asp:GridView ID="gridHealthCheckListItems" DataSourceID="objHealthCheckListItems"
