<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HealthCheckListItem.aspx.cs"
    Culture="en-GB" Inherits="MailTemplates_HealthCheckListItem" EnableViewState="false" EnableTheming="false" %>
...
<body>
    ...
    <div>
        ...
        <br />
        <br />
        <asp:GridView ID="gridHealthCheckListItems" 
            runat="server" CellPadding="4" EnableTheming="False" ForeColor="#333333" GridLines="Vertical">
