...
public partial class controls_HealthcheckSubtabs : System.Web.UI.UserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lbtnHealthcheckmain.NavigateUrl = string.Format("~/WF/Health/healthcheckform.aspx?R=Y&type=main&HealthCheckId={0}&PID={1}",
