...
public partial class controls_InventoryCustomForm : System.Web.UI.UserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                lblCustomer.Text = sessionKeys.PortfolioName;
    ...
    private void BindGrid()
    {
        ...
        int customerId = sessionKeys.PortfolioID;// Convert.ToInt32(customer[0] == "" ? "0" : customer[0]);
    ...
    protected void imgAdd_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            InventoryCustomField.CustomerID = sessionKeys.PortfolioID;//int.Parse(ddlCustomer.SelectedValue);
