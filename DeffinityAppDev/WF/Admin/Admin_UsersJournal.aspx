<%@ Page Title="" Language="C#" MasterPageFile="~/WF/MainTab.master" AutoEventWireup="true" Inherits="Admin_UsersJournal" Codebehind="Admin_UsersJournal.aspx.cs" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="panel_title" runat="Server">
      <%= Resources.DeffinityRes.UserJournal%> 
</asp:Content>
...
<!--Search Block //-->
        <div class="form-group">
                                  <div class="col-md-6">
                                      ...
                                      <div class="col-sm-8"><asp:TextBox ID="txtPageTitle" runat="server" SkinID="txt_80"></asp:TextBox>
<ajaxToolkit:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" MinimumPrefixLength="1" ServiceMethod="GetPageTitles"
 UseContextKey="true" ContextKey="Country" ServicePath="AutoComplete.asmx" TargetControlID="txtPageTitle">
 </ajaxToolkit:AutoCompleteExtender>
					</div>
				</div>
 <div class="col-md-6">
                                       <label class="col-sm-4 control-label"> <%= Resources.DeffinityRes.Users%></label>
                                      <div class="col-sm-8"><asp:DropDownList ID="ddlUsers" runat="server" DataValueField="ID" DataTextField="ContractorName" DataSourceID="obj_Users" SkinID="ddl_80" AppendDataBoundItems="true">
