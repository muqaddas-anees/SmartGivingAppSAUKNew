<%@ Control Language="C#" AutoEventWireup="true" Inherits="MailControls_Timesheet_AdminMail" Codebehind="Timesheet_AdminMail.ascx.cs" %>
...
<tr id="GetApprove" runat="server" visible="false">
    <td>
    <br />
Your timesheet for WC <asp:Label ID="lblWCDate" runat="server" ForeColor="Navy" Font-Bold="true"></asp:Label> has been <asp:Label ID="lblapproval" runat="server" ForeColor="Navy" Font-Bold="true"></asp:Label>  
...
<tr id="Getsubmitt" runat="server" visible="false">
    <td>
      Please submit your timesheet for week commencing <asp:Label ID="lblweekCDate11" runat="server" ForeColor="Navy" Font-Bold="true"></asp:Label>.To log into the system <asp:HyperLink id="getlogin" runat="server" Text="click here"></asp:HyperLink> <asp:Label ID="Label1" runat="server" ForeColor="Navy" Font-Bold="true" Visible="false"></asp:Label>    </td>
</tr>
...
<asp:Label ID="lblNotes" runat="server" Visible="False"  Height="54px"></asp:Label>
</td>
</tr>
