<%@ Page Title="" Language="C#" MasterPageFile="~/WF/MainTab.master" AutoEventWireup="true" Inherits="Timesheet" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" Codebehind="Timesheet.aspx.cs" %>
                                                                    ...
                                                                    <asp:GridView ID="gvInnerTimeSheet" SkinID="gv_nested" runat="server" OnRowDataBound="gvInnerTimeSheet_RowDataBound" 
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Project Title" ItemStyle-CssClass="col-nowrap">
                                                                                ...
                                                                                <FooterTemplate>
                                                                                    <asp:TextBox ID="txtComments" runat="server" Width="200px" Visible="true"></asp:TextBox>
                                                                                </FooterTemplate>
                                                                            </asp:TemplateField>
                                                                            <asp:TemplateField HeaderText="Hours for this T/S">
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Signed Off Hrs">
                                                                                <HeaderStyle Width="60px" HorizontalAlign="Center" />
                                                                                <ItemStyle Width="60px" HorizontalAlign="Right" />
                                                                                <ItemTemplate>
                                                                                ...
                                                                                <FooterTemplate>
                                                                                    <asp:Button ID="btn_declined1" CommandName="DeclineClick"
                                                                                        runat="server" SkinID="btnDefault" Text="Decline"  />
                                                                                </FooterTemplate>
                                                                            </asp:TemplateField>
                                                                            <asp:TemplateField HeaderText="Total Hrs Booked">
                                                                                <HeaderStyle Width="60px" HorizontalAlign="Center" />
                                                                                <ItemStyle Width="60px" HorizontalAlign="Right" />
                                                                                <ItemTemplate>
