<%@ Control Language="C#"  AutoEventWireup="true" Inherits="controls_CheckpointCustomerTab" Codebehind="CheckpointCustomerTab.ascx.cs" %>

<ul class="tabs_list1">
    <li class="<%=GetCssClass(0)%>"><a href="<%=getUrl(0)%>" target="_self"><span>Overview</span></a></li>
   <li class="<%=GetCssClass(10)%>"><a href="<%=getUrl(10)%>" target="_self"><span>Check Point</span></a></li>
