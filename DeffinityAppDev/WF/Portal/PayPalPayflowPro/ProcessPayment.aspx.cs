...
{
    public partial class ProcessPayment_portal : System.Web.UI.Page
    {
        ...
        protected void btnCancel_Click(object sender, EventArgs e)
        {
            if (Request.QueryString["ContactID"] != null)
                Response.Redirect(string.Format("~/WF/Portal/ContactAddressDetails.aspx?ContactID={0}&addid={1}", Request.QueryString["ContactID"].ToString(), Request.QueryString["addid"].ToString()));
        }
