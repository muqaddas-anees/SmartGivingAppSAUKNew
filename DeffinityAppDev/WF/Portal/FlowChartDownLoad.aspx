<%@ Page Language="C#" MasterPageFile="~/WF/CustomerMainTab.master" AutoEventWireup="true" Inherits="FlowChartDownLoad" Title="Customer Flow Charts" Codebehind="FlowChartDownLoad.aspx.cs" %>
<%--<%@ Register Src="~/controls/CustomerHomeTabs.ascx" TagName="CustomerTabs" TagPrefix="uc3" %>--%>
<%--<%@ MasterType VirtualPath="~/WF/CustomerMainTab.master" %>--%>
...
<asp:Content ID="Content5" ContentPlaceHolderID="panel_title" runat="Server">
     <%= Resources.DeffinityRes.FlowCharts%> 
</asp:Content>
