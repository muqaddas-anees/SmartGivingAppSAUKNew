<%@ Page Title="" Language="C#" MasterPageFile="~/WF/MainTab.master" AutoEventWireup="true" EnableEventValidation="false" Inherits="KPIResource" Codebehind="KPIResource.aspx.cs" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="panel_title" runat="Server">
     <%= Resources.DeffinityRes.KPIResources%> 
</asp:Content>
	...
	<div class="col-md-2 form-inline">
        <span class="pull-right">
         <asp:Button ID="imgView" SkinID="btnDefault" Text="Filter" runat="server" 
                    onclick="imgView_Click" /></span>
           <asp:TextBox ID="txtToDate" runat="server" SkinID="Date" Visible="False"></asp:TextBox>
