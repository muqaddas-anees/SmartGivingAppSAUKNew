<%@ Page Language="C#" MasterPageFile="~/WF/MainTab.master" AutoEventWireup="true" Inherits="checkpoint_QACIPS" Title="QACIPS" Codebehind="QACIPS.aspx.cs" %>
...
<div class="form-group">
    ...
    <asp:GridView ID="GridView1" runat="server" 
              ...
              <HeaderStyle Width="60px" />
                ...
                <EditItemTemplate>
                    <asp:LinkButton ID="LinkButtonUpdate" runat="server" CommandName="Update" Text="Update"  CommandArgument='<%# Bind("ID")%>' ValidationGroup="Group1" ToolTip="Update" SkinID="BtnLinkUpdate"></asp:LinkButton>
           ...
           <asp:DropDownList ID="ddresource1" runat="server" DataSourceID="QACIPResource1"
            ...
            <div class="form-group">
      <div class="col-md-2">
          <asp:LinkButton ID="btSend" runat="server" CommandName="EmptyInsert"   UseSubmitBehavior="False" ValidationGroup="Group2" SkinID="BtnLinkAdd"></asp:LinkButton>
	</div>
	<div class="col-md-3">
        <strong> Suggestion for Improvement</strong><br />
         <asp:TextBox ID="txtImprovement2" width="200px" Text =''  runat="server" TextMode="MultiLine" SkinID="txt_90" ></asp:TextBox>
	...
	<div class="col-md-3">
         ...
         <asp:DropDownList ID="ddresource2" runat="server" DataSourceID="QACIPResource2"
                          DataTextField="TEXT" DataValueField="VALUE" Width="155px" SkinID="ddl_90" >
...
<div class="col-md-4">
     ...
     <asp:TextBox ID="txtResultExpected2" runat="server" Width="180px" TextMode="MultiLine" SkinID="txt_90" ></asp:TextBox>
	</div>
</div>
        </EmptyDataTemplate>
                        </asp:GridView>
