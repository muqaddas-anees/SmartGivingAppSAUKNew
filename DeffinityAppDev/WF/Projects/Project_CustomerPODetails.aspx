<%@ Page Title="" Language="C#" MasterPageFile="~/WF/MainTab.master" AutoEventWireup="true" EnableEventValidation="false" Inherits="Project_CustomerPODetails" Codebehind="Project_CustomerPODetails.aspx.cs" %>
...
<%@ Register Src="~/WF/Projects/controls/Project_FinancialSubtab.ascx" TagName="Project_FinalcialSubtab"
    TagPrefix="uc2" %>
<%@ Register Src="~/WF/Projects/controls/CustomerPODetails.ascx" TagName="CustomerPODetails"
    TagPrefix="uc3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <uc2:Project_FinalcialSubtab ID="Project_FinalcialSubtab1" runat="server" />
     <uc4:POTab ID="POTab1" runat="server" />
                <uc3:CustomerPODetails ID="CustomerPODetails" runat="server" />
