<%@ Control Language="C#" AutoEventWireup="true" Inherits="MailControls_ProjectIssue" Codebehind="ProjectIssue.ascx.cs" %>
...
<table align="center" width="600" style="border:1px solid #8595a6; margin-top:10px;" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    Dear <b class="hilite"><label id="lblReciver" runat="server"></label> </b>, <br /><br />
       <label id="lblProjectReference" runat="server"></label> Please review the details below: <label id="lblSender" runat="server" visible="false"></label>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
 ...
 <tr class="hdr">
  ...
  <tr class="hdr" id="pnlHideCustomer1" runat="server">
    <td width="34%">Assign to</td>  
    <td width="33%">Status</td>
    <td width="34%">&nbsp;</td>
  </tr>
  <tr  class="cont_row" id="pnlHideCustomer2" runat="server">
  ...
  <tr >
    <td colspan="4">&nbsp;</td>
     ...
     <tr class="hdr" id="pnlHideCustomer3" runat="server">
    <td colspan="4">Expected outcome</td>
    </tr>
  <tr class="cont_row"  id="pnlHideCustomer4" runat="server">
...
<tr >
    <td colspan="4">
    To update the project <asp:HyperLink ID="linkWebsite" runat="server">please click</asp:HyperLink>  here to access the system.<br /> <br /> 
