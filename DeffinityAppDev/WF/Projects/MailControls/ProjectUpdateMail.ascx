<%@ Control Language="C#" AutoEventWireup="true" Inherits="MailControls_ProjectUpdateMail" Codebehind="ProjectUpdateMail.ascx.cs" %>
...
<table align="center" width="600" style="border:1px solid #8595a6; margin-top:10px;" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td class="hdr1"> Project Updates</td>
  </tr>
</table>    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    Dear <b class="hilite"><label id="lblReciver" runat="server"></label> </b>, <br /><br />
       The following project update has been raised against project <b class="hilite"><label id="lblProjectReference" runat="server"></label> </b> The details of the update are as follows: <label id="lblSender" runat="server" visible="false"></label>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
 <tr class="hdr">
  ...
  <tr  class="cont_row">
    ...
    <td><label id="lblStatus" runat="server"></label>&nbsp; <label ID="ltlDisplay" runat="server"></label></td>
...
<tr >
 ...
 <tr class="hdr">
    ...
    <td colspan="4">Project Update</td>
    </tr>
  <tr class="cont_row" >
 ...
 <%-- <tr >
    <td colspan="4">&nbsp;</td>
     ...
     <tr class="hdr">
    <td colspan="4">Lessons Learnt</td>
    </tr>
  <tr class="cont_row" >
    ...
    <td colspan="4">&nbsp;</td>
     ...
     <tr class="hdr">
    <td colspan="4">Key&nbsp;Achievements&nbsp;Last&nbsp;Week</td>
    </tr>
  <tr class="cont_row" >
    <td colspan="4"><label id="lblAchivement" runat="server"></label>&nbsp;</td>
    </tr>
    <tr >
    <td colspan="4">&nbsp;</td>
    </tr>
     ...
     <tr class="hdr">
    <td colspan="4">Key&nbsp;Tasks&nbsp;This&nbsp;Week</td>
    </tr>
  <tr class="cont_row" >
    <td colspan="4"><label id="lblThisWeek" runat="server"></label>&nbsp;</td>
    </tr>
    <tr >
    <td colspan="4">&nbsp;</td>
    </tr>
