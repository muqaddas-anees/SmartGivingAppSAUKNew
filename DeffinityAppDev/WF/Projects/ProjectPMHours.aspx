<%@ Page Title="" Language="C#" MasterPageFile="~/WF/MainTab.master" AutoEventWireup="true" Inherits="ProjectPMHours" EnableEventValidation="false" Codebehind="ProjectPMHours.aspx.cs" %>
...
<%@ Register Src="controls/Project_FinancialSubtab.ascx" TagName="Project_FinalcialSubtab"
    TagPrefix="uc2" %>
<%@ Register Src="controls/PTPMHours.ascx" TagName="PMHours" TagPrefix="uc4" %>
