<%@ Control Language="C#" AutoEventWireup="true" Inherits="controls_PTMiscTracker" Codebehind="PTMiscTracker.ascx.cs" %>
<style>
    .round
    {
...
<div class="row">
    ...
    <div class="form-group">
             <div class="col-md-12">
                                       <label class="col-sm-7 control-label">Miscellaneous Cost:</label>
                                      <div class="col-sm-5 pull-right control-label"> <asp:Label ID="lblMaterialsCost" runat="server" Font-Bold="true"></asp:Label>
					</div>
				</div>
                </div>
    <div class="form-group">
             <div class="col-md-12">
                                      ...
                                      <div class="col-sm-5 pull-right control-label"><asp:Label ID="lblSpentToDate" runat="server" Font-Bold="true"></asp:Label>
					</div>
				</div>
                </div>
    <div class="form-group">
...
<asp:GridView ID="gvMaterial" runat="server" OnRowDataBound="gvMaterial_RowDataBound"
    ...
    <Columns>
        ...
        <asp:BoundField DataField="Mics" HeaderText="Unit Cost" DataFormatString="{0:C}"
...
<br />
<div>
    <asp:Label ID="lblRes" runat="server" Text=""  ForeColor="Green"></asp:Label></div>
<asp:Button ID="imgUpdate" 
    SkinID="btnUpdate" runat="server" OnClick="imgUpdate_Click" ValidationGroup="mat" />
...
<asp:Panel ID="pnlStorage" runat="server" BackColor="White" Style="display: none"
    Width="750px" Height="500px" BorderStyle="Double" BorderColor="LightSteelBlue"
    ScrollBars="Auto">
    <div style="float: right">
        <asp:LinkButton ID="imghistoryCancel" runat="server" SkinID="BtnLinkClose" OnClick="imghistoryCancel_Click" /></div>
    <div class="sec_header">
        Storage Details</div>
    <hr />
    <p style="font-family: Tahoma; color: Gray; font-size: 9pt;">
        Using this facility you can state where stock is being held by simply selecting
        the location and quantity held in each location.</p>
    <hr />
    ...
    <asp:UpdatePanel ID="UpdatePanelStoregeDetails" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <table width="100%">
                <tr>
                    <td colspan="5">
                        <asp:Label ID="lblMsg" runat="server" ForeColor="Red" Font-Size="8pt"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        ...
                        <ajaxToolkit:CascadingDropDown ID="ccdCategory1" runat="server" TargetControlID="ddlCategory"
                            Category="Name" PromptText="Please select..." PromptValue="0" ServicePath="../InventoryMgr.asmx"
                    ...
                    <td>
                        ...
                        <ajaxToolkit:CascadingDropDown ID="ccdSubCategory" runat="server" TargetControlID="ddlSubCategory"
                            Category="SubCategory" PromptText="Please select..." PromptValue="0" ServicePath="../InventoryMgr.asmx"
                    ...
                    <td>
                        ...
                        <ajaxToolkit:CascadingDropDown ID="CascadingDropDown1" runat="server" TargetControlID="ddlProduct"
                            Category="Product" PromptText="Please select..." PromptValue="0" ServicePath="../InventoryMgr.asmx"
                ...
                <tr>
                    <td>
                        <div style="float: right; padding-right: 300px;">
                            <asp:Button ID="btnAddToInventory" runat="server" SkinID="btnDefault" Text="Add to Inventory" /></div>
                    </td>
                </tr>
                <tr>
                    <td>
