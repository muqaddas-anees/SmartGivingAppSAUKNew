...
public partial class controls_PTStaffHours : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        // This page shows exactly the same as the PM hours page but in place of the PMs we only need to show users that are Resources, 
        // Casual Labour, Service Desk Users, and Service Desk Managers.
    ...
    public void BindingTextboxses()
    {
        ...
        using (projectTaskDataContext pdc = new projectTaskDataContext())
        {
            var x = (from a in pdc.ProjectBudgetedHoursStaffs where a.ProjectReference == PRefid select a).FirstOrDefault();
            if (x == null)
            {
                Lblhours.Text = "0:00";
                LblCost.Text = "";
