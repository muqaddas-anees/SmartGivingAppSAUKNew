...
public partial class controls_ChitChatCtrlHome : System.Web.UI.UserControl
{
    ...
    private void BindData()
    {
        ...
        foreach (DeffinityChat_SelectBYModuleIDResult objItem in GetChatData)
        {
            ...
            else if (strType == "link")
            {
                ...
                strText = strText + "<div class=coment_blk id=" + divMainChildCOMID + ">";
                strText = strText + "<p><a href='" + strUserProfileUrl + "'    onclick=" + strPopUserMain + "><img alt='" + strUserName + "' src='" + strUserProfileImage + "'/></a><a href='" + strUserProfileUrl + "'    onclick=" + strPopUserMain + ">" + strUserName + "</a> posted a link.<br/><br/>";
            ...
            if (GetCommentData != null && GetCommentData.Count() > 0)
            {
                ...
                //if (intCommentsList > 0)
                {
                    ...
                    strText = strText + "<div class='user_cmt_blk' id='" + divCommentTextCOMID + "'>";
                    ...
                    strText = strText + "<a href='" + strUserCommentProfileUrl + "' onclick=" + strPopUser + ">";


                    strText = strText + "<img alt='" + strCommentedUser + "' src='" + strUserCommentProfileImage + "'/></a>";
                ...
                if (intCommentsList > 0)
                {
                    ...
                    strText = strText + "<div class='user_cmt_blk' id='" + divCommentTextCOMIDNew + "'>";
                    //strText = strText + "<div style='display: none' class='user_cmt_blk' id='" + divCommentTextCOMIDNew + "'>";

                    strText = strText + "<a href='" + HiddenProfile.Value + "'>";
                    strText = strText + "<img alt='" + HiddenUserName.Value + "' src='" + HiddenUserPhoto.Value + "'/></a>";
                    strText = strText + "<input id='" + txtCommentIDNew + "' />";
                    strText = strText + "<input id='btnComments' title='Write a comment...'   type='button' value='Comment' onclick='OnComment_InsertClick(" + divMainChildCOMID + "," + txtCommentIDNew + "," + divMainChildCOMID + "," + divCommentTextCOMIDNew + "," + divMainCOMID + ");'" + " /></div>"; ;
    ...
    private string BuildLinks(int intCountLike, int intCommentsList, int intCountMyLike, string divMainCOMID, string divMainChildCOMID, string divLikeCOMID, string divLikethisCOMID, string divUnLikeCOMID, string lblMembersCOMID, string divDelCOMID, string strHideDelete, string strPipe)
    {
        ...
        strText = strText + "<a  title=\'Leave a comment\' href='javascript:DisplayCommentBox(" + divMainChildCOMID + "," + divMainCOMID + ")'>Comment</a> |</div>";
        ...
        strText = strText + "<a href='javascript:LikeOrUnlike(" + divMainChildCOMID + "," + divLikethisCOMID + "," + divLikeCOMID + "," + divUnLikeCOMID + ",1)'>Like</a>" + strPipe + "</div>";
        ...
        strText = strText + "<a href='javascript:LikeOrUnlike(" + divMainChildCOMID + "," + divLikethisCOMID + "," + divLikeCOMID + "," + divUnLikeCOMID + ",0)'>UnLike</a>" + strPipe + "</div>";

        strText = strText + "<div " + strHideDelete + " class=chat_links id=" + divDelCOMID + "><a href='javascript:removedivMainChild(" + divMainChildCOMID + ")'>Delete</a></div>";
        string strLike = "";
