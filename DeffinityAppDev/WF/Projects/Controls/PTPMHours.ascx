<%@ Control Language="C#" AutoEventWireup="true" Inherits="controls_PTPMHours" Codebehind="PTPMHours.ascx.cs" %>
...
<div class="row">
          <div class="col-md-12">
               <asp:ValidationSummary ID="ValidationSummary2" runat="server" DisplayMode="BulletList" ValidationGroup="p" />
	</div>
</div>
...
<asp:Panel ID="pnlBreakdownHours" runat="server">
    <div style="width: 58%; float: right;margin-left:5px;">
        ...
        <strong>  <%= Resources.DeffinityRes.AdditionalPMHours %>  </strong>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Assigned Resource">
                <ItemTemplate>
                    ...
                    <asp:Label ID="LblprojectRef" runat="server" Text="" Visible="false"></asp:Label>
                </ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Total Hours <br/> Budgeted (HH:MM)">
                ...
                <ItemTemplate>
                    <asp:TextBox ID="tMaxHours" Width="50px" SkinID="Price" runat="server" Text='<%# ChangeHours(Eval("MaxHoursAllocated","{0:F2}").ToString())%>'></asp:TextBox>
            ...
            <asp:TemplateField HeaderText="Notify me when <br/> Hours Exceed(HH:MM)" HeaderStyle-Width="5%">
                <HeaderStyle HorizontalAlign="Center" />
                <ItemStyle HorizontalAlign="Right" />
                <ItemTemplate>
