<%@ Page Title="" Language="C#" MasterPageFile="~/WF/MainTab.master" AutoEventWireup="true" Inherits="SDTeamMember" Codebehind="SDTeamMember.aspx.cs" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="panel_title" runat="Server">
      Service Desk Team - <uc2:portfolioddlctr ID="PortfolioDdlCtr1" runat="server" />
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:Panel ID="PnlInsert" runat="server" Width="100%">
        ...
        <div class="form-group row">
                                  <div class="col-md-12">
                                       <label class="col-sm-2 control-label">  <asp:Label ID="lblTeamNames1" runat="server" Text="Team Name"></asp:Label></label>
                                      <div class="col-sm-8 form-inline"> <asp:TextBox ID="txtTeamName" runat="server" SkinID="txt_60"></asp:TextBox>
              ...
              <asp:Button ID="btnPopUp" runat="server" SkinID="btnDefault" Text="Look Up"
                                EnableViewState="false" AlternateText="Look up" />
                                 <asp:Panel ID="pnlSimpleDetails" runat="server" BackColor="White"
                                    Style="display: none" Height="300px" ScrollBars="Both"  Width="450px"  BorderStyle="Double" BorderColor="LightSteelBlue">
                                    ...
                                    <asp:SqlDataSource ID="DS_Otherteams" runat="server" SelectCommand="Deffinity_SDTeam_GetOTherPortfolio"
                    ...
                    <div class="form-group row"><asp:Label ID="lblMessage" runat="server" ForeColor="Red" EnableViewState="False"></asp:Label></div>
        ...
        <div class="col-md-12 text-bold">
            ...
            <hr class="no-top-margin" />
                    ...
                    <div class="form-group row"> <asp:Label ID="lblMessage1" runat="server" ForeColor="Red" EnableViewState="False"></asp:Label></div>
                     <div><asp:LinkButton ID="lnkDelete" runat="server" OnClick="ImgDelete_Click" Font-Bold="true">Delete</asp:LinkButton></div>
...
<asp:TemplateField  HeaderStyle-CssClass="header_bg_l" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="20px">
       ...
       <ItemStyle HorizontalAlign="Center" Width="20px" />
                ...
                <asp:Label ID="lblID" Text='<%# Bind("UserID") %>' runat="server" Visible="false"></asp:Label>
                </ItemTemplate>
...
<!--
    ...
    function HighlightRow(chkB) {
        ...
        if (IsChecked) {
            chkB.parentElement.parentElement.style.backgroundColor = 'LightGray';  // grdEmployees.SelectedItemStyle.BackColor
            ...
            chkB.parentElement.parentElement.style.color = 'black'; //grdEmployees.ItemStyle.ForeColor
                    ...
                    <asp:Panel runat="server"  ID="pnlAddMembers" BackColor="White"  Style="display: none" Height="350px" ScrollBars="None"
                     Width="400px"  BorderStyle="Double" BorderColor="LightSteelBlue">
                        <div class="form-group row">
        <div class="col-md-12 text-bold">
            ...
            <hr class="no-top-margin" />
                    ...
                    <div class="form-group row"> <asp:ValidationSummary ID="ValidationSummary1" runat="server" ValidationGroup="pnlInsert" />
                    <asp:Label ID="lblErrMsg" runat="server"  ForeColor="Red" EnableViewState="false"></asp:Label></div>
                        <div class="form-group row">
                                  <div class="col-md-12">
                                       <label class="col-sm-3 control-label"><asp:Label ID="lblTeam" runat="server" Text="Team"></asp:Label></label>
                                      <div class="col-sm-9"> <asp:Label ID="lblTeamsName" runat="server" Text="" Font-Bold="true"></asp:Label>
					</div>
				</div>
</div>
                        <div class="form-group row">
                                  <div class="col-md-12">
                                       <label class="col-sm-3 control-label">  <asp:Label ID="lblName" runat="server" Text="Name"></asp:Label></label>
                                      <div class="col-sm-9"><asp:Panel Width="235px" runat="server" ID="Panel1" Height="150px" CssClass="form-control">
        <evy:ScrollableListBox ID="CheckBoxList2" runat="server" BorderWidth="0px" 
        RepeatLayout="Flow" Height="135px" Width="220px" ></evy:ScrollableListBox>
                                           </asp:Panel>
					</div>
				</div>
</div>
