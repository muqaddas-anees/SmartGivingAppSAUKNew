<%@ Page Title="" Language="C#" MasterPageFile="~/WF/MainTab.master" AutoEventWireup="true" CodeBehind="ContactAddressDetailsBasic.aspx.cs" Inherits="DeffinityAppDev.WF.CustomerAdmin.ContactAddressDetailsBasic" %>
...
<div class="form-group row">
 ...
 <label class="col-sm-3 control-label">Contact</label>
           <div class="col-sm-9">
               <asp:DropDownList ID="ddlKeyContact" runat="server"></asp:DropDownList>
            </div>
	</div>
</div>
