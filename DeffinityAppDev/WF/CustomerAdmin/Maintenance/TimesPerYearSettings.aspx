<%@ Page Title="" Language="C#" MasterPageFile="~/WF/MainTab.master" AutoEventWireup="true" CodeBehind="TimesPerYearSettings.aspx.cs" Inherits="DeffinityAppDev.WF.CustomerAdmin.TimesPerYearSettings" %>
...
<script>
    $(document).ready(function () {
      ...
      <div class="form-group row">
      <div class="col-md-10">
          <label class="col-sm-2 control-label">Time Per Year</label>
          <div class="col-sm-10 form-inline">
                ...
                //category
                    ...
                    if (id != '0') {
                        ...
                        if ($("[id*=txtName").val().length > 0) {
                            ...
                            displayMsg('lblerror', 'Please select TimeYear', 'error');
                        }
                    }
                    else {
                        //add save data
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("[id*=btnAddTimeYear]").click(function () {
                $("[id*=hid]").val('0');
                $("[id*=htype]").val('2');
                $("[id*=modeltitle]").html("Add TimeYear");
                setPopDefault();
                showAjaxModal();
                return false;
            });
            ...
            $("[id*=btnEditTimeYear]").click(function () {
                $("[id*=hid]").val('0');
                $("[id*=htype]").val('2');
                $("[id*=modeltitle]").html("Edit TimeYear");
                if ($("[id*=htype").val() == '2') {
                    ...
                    if ($("[id*=hid").val() != "0") {
                        ...
                        displayMsg('lblmsg', 'Please select TimeYear', 'error');
                    }
                }
                return false;
            });
    ...
    <script type="text/javascript">
        ...
        function SetTimeYearData() {
            ...
            if (id != "0") {
                $.ajax({
                    type: "POST",
                    url: "../../../WF/CustomerAdmin/Maintenance/services/TimesPerYearSettingsServices.asmx/TimeYearGet",
                    data: "{typeid:'" + id + "'}",
        ...
        function AddTimeYearData() {
            ...
            $.ajax({
                type: "POST",
                url: "../../../WF/CustomerAdmin/Maintenance/services/TimesPerYearSettingsServices.asmx/TimeYearAdd",
                data: dataObject,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
        ...
        function UpdateTimeYearData() {
            ...
            $.ajax({
                type: "POST",
                url: "../../../WF/CustomerAdmin/Maintenance/services/TimesPerYearSettingsServices.asmx/TimeYearUpdate",
                data: dataObject,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
        ...
        function DeleteTimeYearData() {
            ...
            $.ajax({
                type: "POST",
                url: "../../../WF/CustomerAdmin/Maintenance/services/TimesPerYearSettingsServices.asmx/TimeYearDelete",
                data: dataObject,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
