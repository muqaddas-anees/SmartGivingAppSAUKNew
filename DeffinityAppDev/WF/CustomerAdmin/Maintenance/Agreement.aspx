<%@ Page Title="" Language="C#" MasterPageFile="~/WF/MainTab.master" AutoEventWireup="true" CodeBehind="Agreement.aspx.cs" Inherits="DeffinityAppDev.WF.CustomerAdmin.Maintenance.Agreement" %>
...
<hr class="no-top-margin" />
     ...
     <div class="row">
          <div class="col-md-12">
              <asp:Literal ID="lblTerms" runat="server"></asp:Literal>
...
<hr class="no-top-margin" />
 ...
 <label class="col-sm-3 control-label">Date</label>
           ...
           <div class="col-sm-8">
               <asp:TextBox ID="txtApprover" runat="server" SkinID="txt_80"></asp:TextBox>
            </div>
	</div>
          <div class="col-md-4 form-inline">
              <asp:Button SkinID="btnDefault" Text="Submit" runat="server" ID="btnSaveApprover" />
              </div>
