...
public partial class Manage_TeamMembers : System.Web.UI.Page
{
    ...
    string _sqlGetTeamMembersByID1 = "SELECT C.ContractorName as  memName,T.ID,C.EmailAddress,C.ContactNumber,T.Name FROM TeamMember T,Contractors C  WHERE TeamID=@TeamID and C.ID=T.Name";
    #endregion
