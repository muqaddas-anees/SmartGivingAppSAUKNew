<%@ Page Title="" Language="C#" MasterPageFile="~/MasterTabSub.master" AutoEventWireup="true" CodeBehind="CampaignSchedule.aspx.cs" Inherits="DeffinityAppDev.WF.CustomerAdmin.Campaign.CampaignSchedule" %>
         ...
         <div class="col-md-12">
             <asp:GridView ID="GridList" runat="server" OnRowCommand="GridList_RowCommand">
                 <Columns>
                      ...
                      <asp:TemplateField HeaderText="Schedule Date and Time" ItemStyle-Width="220px" HeaderStyle-Width="220px">
                                <ItemTemplate>
                                    <asp:Label ID="lblDate1" runat="server" Text='<%# Bind("StartDate","{0:dd/MM/yyyy HH:mm}") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                     <asp:TemplateField HeaderText="End Date and Time" ItemStyle-Width="220px" HeaderStyle-Width="220px" Visible="false">
                                <ItemTemplate>
                                    <asp:Label ID="lblDate2" runat="server" Text='<%# Bind("EndDate") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                    ...
                    <%-- <asp:TemplateField HeaderText="Subject" >
                     ...
                     <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtnDelete" runat="server" CausesValidation="False" CommandName="del" SkinID="BtnLinkDelete" OnClientClick='return confirm("Do you really want to delete scheduled item?");' CommandArgument='<%# Bind("ID") %>'></asp:LinkButton>
                                </ItemTemplate>
                                <ItemStyle Width="40px" />
                            </asp:TemplateField>
                 </Columns>
