<%@ Page Title="" Language="C#" MasterPageFile="~/WF/MainTab.master" AutoEventWireup="true" CodeBehind="CustomerAddressList.aspx.cs" Inherits="DeffinityAppDev.WF.CustomerAdmin.CustomerAddressList" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="panel_title" runat="server">
    <asp:Literal ID="lblContact" runat="server"></asp:Literal> - <asp:Literal ID="lblAddress" runat="server" Text="Address"></asp:Literal>
</asp:Content>
<asp:Content ID="Content6" ContentPlaceHolderID="panel_options" runat="server">
</asp:Content>
<asp:Content ID="Content7" ContentPlaceHolderID="MainContent" runat="server">
     <asp:HiddenField ID="hpartner" runat="server" ClientIDMode="Static" />
    <asp:HiddenField ID="hplanaccess" runat="server" ClientIDMode="Static" />
 ...
 <script type="text/javascript" language="javascript" class="init">
     ...
     function BindAddress() {
         editor = new $.fn.dataTable.Editor({
             ...
             // {
             //     label: "Policy Starts:",
             //     name: "PortfolioContactAddress.PolicyStartsID",
             //     type: "select",
             //     placeholder: "Please select..."
             // },
             //  {
             ...
             //   {
             //       label: "Contract Term:",
             //       name: "PortfolioContactAddress.ContractTermID",
             //       type: "select",
             //       placeholder: "Please select..."
             //   },
                {
             ...
             //    },
                  ...
                  {
                      label: "Amount:",
                      name: "PortfolioContactAddress.Amount"
             ...
             //      {
             //          label: "Name:",
             //          name: "PortfolioContactAddress.BillingName"

             //      },
             //       {
             //           label: "Address1:",
             //           name: "PortfolioContactAddress.BillingAddress1"
             //       },
             //        {
             //            label: "Address2:",
             //            name: "PortfolioContactAddress.BillingAddress2"
             //        },
             //         {
             //             label: "City:",
             //             name: "PortfolioContactAddress.BillingCity"

             //         },
             //          {
             //              label: "State:",
             //              name: "PortfolioContactAddress.BillingState"

             //          },
             //           {
             //               label: "Zipcode:",
             //               name: "PortfolioContactAddress.BillingZipcode"
         ...
         table = $('#example').DataTable({
             ...
             columns: [
                 ...
                 {
                     data: "PortfolioContactAddress.Amount", className: "dt-right", title: "Amount",
                     render: function (data, type, row) {
                         var v = row.PortfolioContactAddress.Amount;
                 ...
                 },
                 {
                     ...
                     render: function (data, type, row) {
                         ...
                         var d = a.diff(b, 'days');
                         //hplanaccess
                         var pid = $("#hpartner").val();
                         if (pid == "2") {
                             return ("<a href='' class='show_edit2 btn btn-secondary' style='margin- bottom:0px'>Smart Maintenance</a>");
                         }
                         else {
                             if (d > 0)
                                 return ("<a href='' class='show_edit1 btn btn-blue' style='margin- bottom:0px'>Plan Active</a>");
                             else
                                 return ("<a href='' class='show_edit1 btn btn-secondary' style='margin- bottom:0px'>Maintenance Plan</a>" );
                             //return ("<span style='color:white;font-weight:bold;' class='statuscls1'> Expired</span>");
                         }
                         },
                     //defaultContent: '<a href="" class="show_edit1 btn btn-secondary" style="margin-bottom:0px">Maintenance Plan</a>',
                     //"visible": false
                 },
                  {
                      orderable: false,
         ...
         $('#example').on('click', 'a.show_edit2', function (e) {
             e.preventDefault();
             var tr = $(this).closest('tr');
             var row = table.row(tr);
             ...
             var data1 = row.data();
             var d = data1['PortfolioContactAddress']["ID"];
             window.location.href = "Maintenance/MaintenanceNavigation.ashx?ContactID=" + getUrlParameter('ContactID') + "&addressid=" + d;
             //debugger;
             //$('#haid').val(data1['PortfolioContactAddress']["ID"]);
             //$('.pnl').show();
             //assets_table_load();
