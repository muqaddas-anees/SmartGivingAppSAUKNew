<%@ Control Language="C#" AutoEventWireup="true" Inherits="controls_ChitChatCtrlHomeNew" Codebehind="ChitChatCtrlHomeNew.ascx.cs" %>
...
<script type="text/javascript">
    ...
    function AddChild_To_divMainListFile(TopicID) {
        ...
        var strLikeLineImg = 'fa fa-book';
        var strDownloadImg = 'fa fa-download';
        var strSize = '(2 KB)';
        ...
        var ProfileImage = '<a class=xe-user-img href=\'' + strProfileLink + '\'' + '   onclick=' + strPop + '\'/><img class=img-circle src=\'' + strProfileImg + '\' alt=\'' + strUserName + '\' /></a>';


        var CommentsLine = '<span id=\'' + hrfIDValue + '\' class=\'chat_links\' ><a  title=\'Leave a comment\'   href=\'javascript:DisplayCommentBox(' + divIdName + ',' + hrfIDValue + ') \'   ><i class=\'linecons-comment\'></i> Comment</a>  |</span>';  //'<a href=\'default.aspx\'>Comments </a>';
        var LikeLine = '<span id=\'' + LikeIDValue + '\' class=\'chat_links\' ><a href=\'javascript:LikeOrUnlike(' + divIdName + ',' + divLikethis + ',' + LikeIDValue + ',' + UnLikeIDValue + ',' + '1) \' ><i class=\'linecons-thumbs-up\'></i> Like</a> |</span>';
        var UnLikeLine = '<span id=\'' + UnLikeIDValue + '\' style=\'display: none;\' class=\'chat_links\' ><a href=\'javascript:LikeOrUnlike(' + divIdName + ',' + divLikethis + ',' + LikeIDValue + ',' + UnLikeIDValue + ',' + '0) \' >UnLike </a> |</span>';
        var DeleteLine = '<span id=\'' + DelIDValue + '\' class=\'chat_links\' ><a href=\'javascript:removedivMainChild(' + divIdName + ') \'   ><i class=\'linecons-trash\'></i> Delete</a></span>';
        ...
        var FileDownloadLink = '<a href=\'' + UploadedFile + '\'><i  class=\'' + strDownloadImg + '\'/>Download txt</a>' + strSize;
    ...
    function AddChild_To_divMainListText(TopicID) {
        ...
        var CommentsLine = '<span id=\'' + hrfIDValue + '\' class=\'chat_links\' > <a  title=\'Leave a comment\'  href=\'javascript:DisplayCommentBox(' + divIdName + ',' + hrfIDValue + ') \' ><i class=\'linecons-comment\'></i> Comment</a> |</span>';  //'<a href=\'default.aspx\'>Comments </a>';
        var LikeLine = '<span id=\'' + LikeIDValue + '\' class=\'chat_links\' ><a  title=\'Like this\' href=\'javascript:LikeOrUnlike(' + divIdName + ',' + divLikethis + ',' + LikeIDValue + ',' + UnLikeIDValue + ',1) \' ><i class=\'linecons-thumbs-up\'></i> Like </a> |</span>';
        var UnLikeLine = '<span id=\'' + UnLikeIDValue + '\' style=\'display: none;\'   title=\'UnLike this\' class=\'chat_links\' ><a href=\'javascript:LikeOrUnlike(' + divIdName + ',' + divLikethis + ',' + LikeIDValue + ',' + UnLikeIDValue + ',0) \' >UnLike </a> |</span>';

        var DeleteLine = '<span id=\'' + DelIDValue + '\' class=\'chat_links\' ><a href=\'javascript:removedivMainChild(' + divIdName + ') \'   ><i class=\'linecons-trash\'></i> Delete</a></span>';
        var LikeThisLine = '<div class=\'clr\'></div><div id=\'' + divLikethis + '\' class=\'likeunlike\'  style=\'display: none;\'  ><b>&nbsp;</b>Like this article</div>';
        var todaydate = '<Time id=\'' + DateIDValue + '\' class=\'chat_timestamp\' >' + DateTimeJs() + '</Time>';
    ...
    function AddChild_To_divMainListLink(TopicID) {
        ...
        var CommentsLine = '<span id=\'' + hrfIDValue + '\' class=\'chat_links\' ><a  title=\'Leave a comment\'  href=\'javascript:DisplayCommentBox(' + divIdName + ',' + hrfIDValue + ') \'   ><i class=\'linecons-comment\'></i> Comments</a>|</span>';
        var LikeLine = '<span id=\'' + LikeIDValue + '\' class=\'chat_links\' ><a href=\'javascript:LikeOrUnlike(' + divIdName + ',' + divLikethis + ',' + LikeIDValue + ',' + UnLikeIDValue + ',' + '1) \' ><i class=\'linecons-thumbs-up\'></i> Like </a> |</span>';
        var UnLikeLine = '<span id=\'' + UnLikeIDValue + '\' style=\'display: none;\' class=\'chat_links\' ><a href=\'javascript:LikeOrUnlike(' + divIdName + ',' + divLikethis + ',' + LikeIDValue + ',' + UnLikeIDValue + ',' + '0) \' >UnLike </a> |</span>';
        var DeleteLine = '<span id=\'' + DelIDValue + '\' class=\'chat_links\' ><a href=\'javascript:removedivMainChild(' + divIdName + ') \'   ><i class=\'linecons-trash\'></i> Delete</a></span>';
        ...
        var PostedLinkimg = '<a href=\'' + strLikeLineUrl + '\'  target=\'_blank\' title=\'' + strLikeLineUrl + '\' ><i class=\'' + strLikeLineImg + '\'   title=\'' + strLikeLineUrl + '\' /> </a>';
    ...
    function DisplayCommentBoxOpen(divNum, hrfIDValue) {
        ...
        newdivSecond.className = 'user_cmt_blk1';
        ...
        var commentBox = ProfileImage + '<input style=\' height:50px \' id=\'' + txtCommentBoxID + '\'  /> <input class=\' btn btn-secondary\' id=\'btnComments\' title=\'Write a comment...\' value=\'Comment\' type=\'button\' onclick=\'OnComment_InsertClick(' + divNum + ',' + txtCommentBoxID + ',' + divNum + ',' + divIdNameSecond + ',' + hrfIDValue + ');\' />';
    ...
    function DisplayCommentBox(divNum, hrfIDValue) {
        ...
        var txtCommentBoxID = 'txtComment' + guidVal;
        var PostedText = 'posted a file.';
        var commentBox = ProfileImage + '<input id=\'' + txtCommentBoxID + '\'   /> <input class=\' btn btn-secondary\' id=\'btnComments\' title=\'Comment\' value=\'Comment\' type=\'button\' onclick=\'OnComment_InsertClick(' + divNum.id + ',' + txtCommentBoxID + ',' + divNum.id + ',' + divIdNameSecond + ',' + hrfIDValue.id + ');\' />';
    ...
    function AddLikeDIV(divParent, CommentText, CommentID) {
        ...
        var todaydate = '<time id=\'' + DateIDValue + '\' class=\'chat_timestamp\' >' + DateTimeJs() + '</time><br/>';
        var commentBoxDisplay = ProfileImage + UserName + todaydate + CommentText + '</br>';
    ...
    function AddComment(divParent, CommentID, CommentText) {
        ...
        newdiv.setAttribute('id', divIdNameFirst);
        newdiv.className = 'user_cmt_blk1';
        ...
        var commentBoxDisplay = ProfileImage + UserName + todaydate + ' ' + CommentText.value + '<br/><br/>' + DeleteLine;
        newdiv.innerHTML = commentBoxDisplay;
    ...
    function txtshareonfocus() {
        ...
        var txtName = document.getElementById('<%=txtTextShare.ClientID%>');
            ...
            <asp:TextBox ID="TextBox1" runat="server" Height="125px" TextMode="MultiLine" 
                SkinID="txt_90" Visible="False"   ></asp:TextBox>
       
<div class="card shadow-sm">
        <div class="card-header">
							<h3 class="card-body"><%= Resources.DeffinityRes.RecentChitChat%></h3>
    ...
    <div class="panel-body">
        ...
        <asp:HiddenField    ID="HiddenModuleID" runat="server" />
          ...
          <div class="col-xs-10 form-inline">
              <textarea id="txtTextShare" rows="2" cols="60" runat="server" style="width:98%;height:60px"></textarea>
               <label id="lblTextShare" runat="server" style="visibility:hidden;color:Red" >*</label>
               
	</div>
                 <div  class="col-xs-2">
                     <input id="btnMainShare" style="height:60px;vertical-align:top;"  class="btn_share btn btn-secondary" title="<%$ Resources:DeffinityRes,Share%>" value="Share" runat="server"  type="button" onclick="OnMainShareText_InsertClick();" />  
               </div>
</div>
            <div class="form-group row">
          <div class="col-xs-12 form-inline">
               <div class="form-group row">
          <div class="col-xs-12 form-inline attachment profile-post-form" id="divAttachfileAndLink"   runat="server">
              <ul class="list-unstyled list-inline form-action-buttons">
								<li>
									   <a href="javascript:AttachFile();">  <%= Resources.DeffinityRes.Attach%></a>
								</li>
								<li>
									 <a href="javascript:AttachLink();"  ><i class="fa fa-link"></i></a>
								</li>
								<li>
									 <a href="javascript:AttachLink();" id="A2" runat="server"><%= Resources.DeffinityRes.Link%></a>
                                    <a  style="display: none;" href="javascript:AttachFile();" id="hrefAttach" runat="server">File</a>
								</li>
							</ul>
              ...
              <div class="form-group row">
                  <div class="col-xs-12" id="divAttach" style="display:none;" runat="server">
                       <div class="form-group row">
        <div class="col-xs-12">
            <div class="col-sm-8">
           <i class="el-attach"></i><%= Resources.DeffinityRes.AttachaFile%> 
                </div>
             <div class="col-sm-4">
                  <a href="javascript:AttachFile();" id="A1" title="Close the publisher"><i class='fa-close'></i></a>
                 </div>
            <hr class="no-top-margin" />
                       ...
                       <div class="form-group row">
      <div class="col-xs-12">
           <label class="col-sm-6 control-label"><%= Resources.DeffinityRes.Selectafile%> </label>
           <div class="col-sm-6">
<input type="file" id="txtfileUpload" />
                       ...
                       <div class="form-group row">
      <div class="col-xs-12">
           <label class="col-sm-6 control-label"><%= Resources.DeffinityRes.Name%>  </label>
           <div class="col-sm-6">
			<input id="txtfileName" class="form-control" />
            </div>
	</div>
</div>
                        <div class="form-group row">
      <div class="col-xs-12">
           <label class="col-sm-6 control-label"><%= Resources.DeffinityRes.Description%> </label>
           <div class="col-sm-6">
 <textarea id="txtfileDesc" cols="30" rows="3" class="form-control"></textarea>
            </div>
	</div>
</div>
                        <div class="form-group row">
      <div class="col-xs-12">
           ...
           <div class="col-sm-6">
	<input id="btnShareFile" title="Share File" value="Share File" type="button" class="btn btn-secondary" onclick="OnMainShareFile_InsertClick();" />
</div>
</div>
                </div>
               ...
               <div class="form-group row">
          <div class="col-xs-12" id="divLink" style="display:none;" runat="server">
              <div class="form-group row">
        <div class="col-md-12">
            <div class="col-sm-9">
          <i class="fa fa-link"></i><%= Resources.DeffinityRes.AttachaLink%>  
                </div>
             <div class="col-sm-3 pull-right">
                   <a href="javascript:AttachLink();" id="hrefAttachLinkClose" title="Close">
                     <i class='fa-close'></i></a> 
                 </div>
            <hr class="no-top-margin" />
            </div>
    </div>
                    <div class="form-group row">
      <div class="col-xs-12">
           <label class="col-sm-6 control-label"><%= Resources.DeffinityRes.LinkURL%> </label>
           <div class="col-sm-6">
<input id="txtLinkURL" value="http://" class="form-control" />
            </div>
	</div>
</div>
                    <div class="form-group row">
      <div class="col-xs-12">
           <label class="col-sm-6 control-label"><%= Resources.DeffinityRes.LinkName%> </label>
           <div class="col-sm-6">
 <input id="txtLinkName" class="form-control" />
            </div>
	</div>
</div>
<div class="form-group row">
      <div class="col-xs-12">
           <label class="col-sm-6 control-label">&nbsp;</label>
           <div class="col-sm-6">
<input id="btnShareLink" title="<%= Resources.DeffinityRes.ShareLink%>" value="Share Link" type="button" class="btn btn-secondary" onclick="OnMainShareLink_InsertClick();" />
            </div>
	</div>
</div>
		...
		<!-- Timeline Story Type: Status -->
               ...
               <div id="divMainCOM"  class="chatscroll scrollable" runat="server" data-max-height="550">
