<%@ Page Title="" Language="C#" MasterPageFile="~/MainTab.master" AutoEventWireup="true" CodeBehind="AdminSettings.aspx.cs" Inherits="DeffinityAppDev.WF.DC.AdminSettings" %>
       ...
       <div class="col-md-6 col-xl-3 card border-0 m-5 m-5">
										...
										<a href="#" class="card border-hover-primary">
											...
											<div class="card-body p-9" style="height: 180px;">
												...
												<!--end::Name-->
												<!--begin::Description-->
												<p class="text-gray-400 fw-bold fs-5 mt-1 mb-7"> Allows you to add company information such as bank details that appear on an invoice as well as change the logo on the portal.</p>
...
<a href="#" class="card border-hover-primary">
	<div class="card-header border-0 pt-9">
		<div class="card-title m-0">
			...
			<p class="text-gray-400 fw-bold fs-5 mt-1 mb-7">       Add your team members in this section</p>
			</div>
                                            <div class="card-footer">
...
<a href="#" class="card border-hover-primary">
	<div class="card-header border-0 pt-9">
		<div class="card-title m-0">
			...
			<p class="text-gray-400 fw-bold fs-5 mt-1 mb-7">     Set up your preferred Card Payment Provider</p>
			</div>
                                            <div class="card-footer">
...
<a href="#" class="card border-hover-primary">
	<div class="card-header border-0 pt-9">
		<div class="card-title m-0">
			...
			<p class="text-gray-400 fw-bold fs-5 mt-1 mb-7"> Donation Categories</p>
			</div>
                                            <div class="card-footer">
...
<a href="#" class="card border-hover-primary">
	<div class="card-header border-0 pt-9">
		<div class="card-title m-0">
			...
			<p class="text-gray-400 fw-bold fs-5 mt-1 mb-7"> Timesheet Approver</p>
			</div>
                                            <div class="card-footer">
...
<a href="#" class="card border-hover-primary">
	<div class="card-header border-0 pt-9">
		<div class="card-title m-0">
			...
			<p class="text-gray-400 fw-bold fs-5 mt-1 mb-7">        Create accounting codes for your expenses</p>
			</div>
                                            <div class="card-footer">
...
<a href="#" class="card border-hover-primary">
	<div class="card-header border-0 pt-9">
		<div class="card-title m-0">
			...
			<p class="text-gray-400 fw-bold fs-5 mt-1 mb-7">        Page Builder</p>
			</div>
                                            <div class="card-footer">
...
<a href="#" class="card border-hover-primary">
	<div class="card-header border-0 pt-9">
		<div class="card-title m-0">
			...
			<div class="card-body p-9" style="height: 180px;">
			<div class="fs-1 fw-bolder text-dark">Tax</div>
			<p class="text-gray-400 fw-bold fs-5 mt-1 mb-7"> Enter the TAX rate. This defaults to 12%</p>
			</div>
                                            <div class="card-footer">
...
<a href="#" class="card border-hover-primary">
	<div class="card-header border-0 pt-9">
		<div class="card-title m-0">
			...
			<p class="text-gray-400 fw-bold fs-5 mt-1 mb-7">  This sets the default % mark up of a job when you create an estimate. By default we set
this to 25%.</p>
			</div>
                                            <div class="card-footer">
...
<a href="#" class="card border-hover-primary">
	<div class="card-header border-0 pt-9">
		<div class="card-title m-0">
			...
			<p class="text-gray-400 fw-bold fs-5 mt-1 mb-7">   Where the job originated from</p>
			</div>
                                            <div class="card-footer">
...
<a href="#" class="card border-hover-primary">
	<div class="card-header border-0 pt-9">
		<div class="card-title m-0">
			...
			<p class="text-gray-400 fw-bold fs-5 mt-1 mb-7">    The category of the job </p>
			</div>
                                            <div class="card-footer">
...
<a href="#" class="card border-hover-primary">
	<div class="card-header border-0 pt-9">
		<div class="card-title m-0">
			...
			<p class="text-gray-400 fw-bold fs-5 mt-1 mb-7">    This sets the email that the system sends emails to your customer from. You can set it to any valid email address.</p>
			</div>
                                            <div class="card-footer">
...
<a href="#" class="card border-hover-primary">
	<div class="card-header border-0 pt-9">
		<div class="card-title m-0">
			...
			<p class="text-gray-400 fw-bold fs-5 mt-1 mb-7">     The bottom section of an <b>e-mail</b> message that contains information that does not change from one <b>e-mail</b> marketing campaign to another</p>
			</div>
                                            <div class="card-footer">
...
<a href="#" class="card border-hover-primary">
	<div class="card-header border-0 pt-9">
		<div class="card-title m-0">
			...
			<p class="text-gray-400 fw-bold fs-5 mt-1 mb-7">     Donation Thank  You Email</p>
			</div>
                                            <div class="card-footer">
...
<a href="#" class="card border-hover-primary">
	<div class="card-header border-0 pt-9">
		<div class="card-title m-0">
			...
			<p class="text-gray-400 fw-bold fs-5 mt-1 mb-7">    Use this section to create custom fields to store specific data about your members</p>
			</div>
                                            <div class="card-footer">
...
<a href="#" class="card border-hover-primary">
	<div class="card-header border-0 pt-9">
		<div class="card-title m-0">
			...
			<p class="text-gray-400 fw-bold fs-5 mt-1 mb-7">         Set the default sales markup price within estimates. The portal will apply a 25% mark-up by default.</p>
			</div>
                                            <div class="card-footer">
...
<a href="#" class="card border-hover-primary">
	<div class="card-header border-0 pt-9">
		<div class="card-title m-0">
			...
			<p class="text-gray-400 fw-bold fs-5 mt-1 mb-7">        Enable Internal Cost.</p>
			</div>
                                            <div class="card-footer">
...
<a href="#" class="card border-hover-primary">
	<div class="card-header border-0 pt-9">
		<div class="card-title m-0">
			...
			<p class="text-gray-400 fw-bold fs-5 mt-1 mb-7">        The category of equipment that you will store in your warehouse or vans.</p>
			</div>
                                            <div class="card-footer">
...
<a href="#" class="card border-hover-primary">
	<div class="card-header border-0 pt-9">
		<div class="card-title m-0">
			...
			<p class="text-gray-400 fw-bold fs-5 mt-1 mb-7">       Vans, warehouses, offices where you plan to store your equipment.</p>
			</div>
                                            <div class="card-footer">
...
<a href="#" class="card border-hover-primary">
	<div class="card-header border-0 pt-9">
		<div class="card-title m-0">
			...
			<p class="text-gray-400 fw-bold fs-5 mt-1 mb-7">     If you have a list of products and services that you offer your clients on a regular basis then you can configure them here. This will make creating estimates simpler. </p>
			</div>
                                            <div class="card-footer">
