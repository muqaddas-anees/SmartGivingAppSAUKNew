<%@ Page Title="" Language="C#" MasterPageFile="~/WF/MainTab.master" AutoEventWireup="true" CodeBehind="DCFormNewOld.aspx.cs" Inherits="DeffinityAppDev.WF.DC.DCFormNew" EnableEventValidation="false" %>
...
<script>
    ...
    <script type="text/javascript">
        ...
        function UpdateSubCategoryContactData() {
            ...
            $.ajax({
                type: "POST",
                url: "../../WF/DC/Services/AdminServices.asmx/FormUpdate",
                data: dataObject,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
        ...
        function DeleteSubCategoryContactData() {
            ...
            $.ajax({
                type: "POST",
                url: "../../WF/DC/Services/AdminServices.asmx/FormDelete",
                data: dataObject,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
    ...
    <script type="text/javascript">
        ...
        function AddServiceContactData() {
            ...
            $.ajax({
                type: "POST",
                url: "../../WF/DC/Services/AdminServices.asmx/FormPanelAdd",
                data: dataObject,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
        ...
        function UpdateServiceContactData() {
            ...
            $.ajax({
                type: "POST",
                url: "../../WF/DC/Services/AdminServices.asmx/FormPanelUpdate",
                data: dataObject,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
        ...
        function UpdateRowPositionData(id, panelid, newposition, oldPosition) {
            ...
            $.ajax({
                type: "POST",
                url: "../../WF/DC/Services/AdminServices.asmx/FromDataUpdatePosition",
                data: dataObject,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: true,
   ...
   <script type="text/javascript">
       ...
       function GetFormData(jobid) {
           ...
           try {
               ...
               $.ajax({
                   url: "../../WF/DC/Services/AdminServices.asmx/BindFromDataByFormAndJobID",
                   type: "POST",
                   data: dataObject,
                   contentType: 'application/json; charset=utf-8',
                   dataType: "json",
                       ...
                       for (var i = 0; i < NewData.length; i++) {
                          ...
                          // setServiceDropdownValue();
                           ...
                           if (TypeOfField == "Subheading") {
                               ...
                               x = x + "<div class='form-group'><div class='col-md-12'>";
