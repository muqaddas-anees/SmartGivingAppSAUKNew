<%@ Page Title="" Language="C#" MasterPageFile="~/MasterTabSub.master" AutoEventWireup="true" CodeBehind="DCFormNew.aspx.cs" Inherits="DeffinityAppDev.WF.DC.DCFormNew1" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="panel_options" runat="server">
     <asp:Button ID="btnSave" runat="server" SkinID="btnDefault" Text="Save Changes" ClientIDMode="Static" style="float:right;" /> 
</asp:Content>
