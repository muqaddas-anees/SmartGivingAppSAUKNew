<%@ Control Language="C#" AutoEventWireup="true" Inherits="MailControls_SDTeamToCustomer_Complete" Codebehind="SDTeamToCustomer_Complete.ascx.cs" %>
...
<table align="center" width="600" style="border:5px solid #b3b3b3; margin-top:10px;" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td class="hdr1"><asp:Label ID="lblbType" runat="server"></asp:Label></td>
  </tr>
</table> 
   </td>
  </tr>
  ...
  <tr>
    ...
    <p>Thank you for your order which was placed on: <b class="hilite"><label id="lblOrderLoggedDate" runat="server"></label></b>. Your reference is:  <b class="hilite"><label id="lblIncidentID" runat="server"></label> </b></p>
       
        
        <p style="font-weight:bold;">Details are as follows:</p> 
...
<tr >
    <td colspan="2">
    <p><b>Total: </b><label style="font-weight:bold" id="lblRevisedPric" runat="server"></label> </p>
    <p>Please keep a note of this order in case you need to discuss it with us. Should you have any issues please contact us.</p>
    <br /> <br /> 
Thank you.<br /><br />
