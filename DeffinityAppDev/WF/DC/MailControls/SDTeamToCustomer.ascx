<%@ Control Language="C#" AutoEventWireup="true" Inherits="MailControls_SDTeamToCustomer" Codebehind="SDTeamToCustomer.ascx.cs" %>
...
<table align="center" width="600" style="border:5px solid #b3b3b3; margin-top:10px;" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    Dear <b class="hilite"><label id="lblReciver" runat="server"></label> </b>, <br /><br />
        <p><%--Facilities--%> <asp:Literal ID="lblInstnaceTitle" runat="server"></asp:Literal> have provided you with a revised quotation for <asp:Label ID="lblPrefix" runat="server"> </asp:Label> number: <b class="hilite"><label id="lblIncidentID" runat="server"></label> </b></p>
...
<td colspan="2">Notes:<br /> <label id="lblNotes1" runat="server"></label></td>
...
<tr >
    ...
    <p>Otherwise please access the system by <asp:HyperLink ID="linkPendingApproval" runat="server">clicking here</asp:HyperLink> &nbsp;to amend your order. <%--[change status - Pending Awaiting Approval]--%></p>
