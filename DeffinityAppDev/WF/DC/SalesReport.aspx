<%@ Page Title="" Language="C#" MasterPageFile="~/MasterTabSub.master" AutoEventWireup="true" CodeBehind="SalesReport.aspx.cs" Inherits="DeffinityAppDev.WF.DC.SalesReport" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="MainContent" runat="server">
    ...
    color: white;
     ...
     <div class="form-group row" style="display:none;visibility:hidden">
                                  <div class="col-md-12">
                                       <label class="col-sm-2 control-label"> Select Chat</label>
                                      <div class="col-sm-5 form-inline"> 
                                          <asp:DropDownList ID="ddlType" runat="server">
                                              <asp:ListItem Value="1" Text="Type of Request by Transaction Value"></asp:ListItem>
                                              <asp:ListItem Value="2" Text="Technician vs Transaction Value"></asp:ListItem>
                                              <asp:ListItem Value="3" Text="Category by Transaction Value"></asp:ListItem>
                                          </asp:DropDownList>
                                          </div>
                                      </div>
         </div>
	...
	<div class="col-md-3">
           ...
           <label class="col-sm-2 control-label"><%= Resources.DeffinityRes.Status%></label>
           <div class="col-sm-10">
...
<hr class="no-top-margin" />
 ...
 <div class="row">
                  <div class="col-md-12">
                      ...
                      <asp:Literal ID="lbltable" runat="server"></asp:Literal>
  ...
  <script type="text/javascript">
      ...
      function GetIssuesData() {
          ...
          var period = $("[id$='ddlPaymentStatus']").val();
          $.ajax({
              url: '../../WF/DC/webservices/DCServices.asmx/GetDataBySales',
              type: "POST",
      ...
      function GetAssetRecords() {
          ...
          debugger;
          $.ajax({
              url: "../../WF/DC/webservices/DCServices.asmx/BindSaleData",
              type: "POST",
              data: "{'fromdate': '" + fromdate + "','todate':'" + todate + "','search':'" +search+ "','period':'" + period  +"'}",
              contentType: 'application/json; charset=utf-8',
              dataType: "json",
              ...
              success: function (data) {
                  ...
                  for (var i = 0; i < NewData.length; i++) {
                      ...
                      var AssignTechnician = NewData[i].AssignTechnician;
                      var TypeOfRequest = NewData[i].TypeOfRequest;
                      var Paypalref = NewData[i].paypalref;
                      var Transval = NewData[i].transval;
                      var Deatils = NewData[i].details;
                      var TicketManager = NewData[i].TicketManager;
                      x = x + "<tr><td style=direction:rtl>" + DateClosedDis
                          ...
                          + "</td><td>" + TypeOfRequest
                          + "</td><td>" + Category
                          + "</td><td style=direction:rtl>" + Transval
                          + "</td><td>" + Paypalref
                          + "</td><td>" + TicketManager
                          + "</td><td>" + AssignTechnician + "</td></tr>";
                  }
