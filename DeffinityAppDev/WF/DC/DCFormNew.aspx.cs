...
{
    public partial class DCFormNew1 : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    if (QueryStringValues.CCID > 0)
                        lblTitle.InnerText = "Form for " + " Job Reference " + QueryStringValues.CCID + ": " + FLSDetailsBAL.GetJobDetails(QueryStringValues.CallID);
                    else
                        lblTitle.InnerText = "Form for " + " " + Resources.DeffinityRes.ServiceDesk;
