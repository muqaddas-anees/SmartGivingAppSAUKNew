<%@ Control Language="C#" AutoEventWireup="true" Inherits="DC_controls_JlistHome" Codebehind="JlistHome.ascx.cs" %>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('#FLSTableContainer').jtable({
            ...
            actions: {
                listAction: 'DC/DCCustomerJlist.aspx/GetHome'
            },
        ...
        $('#FLSTableContainerOrder').jtable({
            ...
            defaultSorting: 'CallID DESC',
            actions: {
                listAction: 'DC/DCCustomerJlist.aspx/GetHomeOrder'
            },

            messages: {
                serverCommunicationError: 'An error occured while communicating to the server.',
                loadingMessage: 'Loading orders...',
                noDataAvailable: 'No 0rders available!',
                addNewRecord: '+ Add new',
                editRecord: 'Edit',
                areYouSure: 'Are you sure?',
                deleteConfirmation: 'This record will be deleted. Are you sure?',
            ...
            fields: {
                CallID: {
                    ...
                    display: function (data) {
                        //                            return '<a href="FLSForm.aspx?callid=' + data.record.CallID + '"><b>TN:' + data.record.CallID + '</b></a>';
                        return '<a href="DC/DCServices.aspx?callid=' + data.record.CallID + '"><b>TN:' + data.record.CallID + '</b></a>';
                    }
                },
