<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PermitTab.ascx.cs" Inherits="DeffinityAppDev.WF.DC.controls.PermitTab" %>
...
<ul class="nav navbar-nav">
    ...
    <li><a id="lbtnChecklists" href="~/WF/DC/Checklist.aspx" target="_self" runat="server"><%= Resources.DeffinityRes.CheckList%></a></li>
