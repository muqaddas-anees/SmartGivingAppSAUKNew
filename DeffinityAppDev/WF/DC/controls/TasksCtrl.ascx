<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TasksCtrl.ascx.cs" Inherits="DeffinityAppDev.WF.DC.controls.TasksCtrl" %>
...
<script type="text/javascript">
											...
											<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
												...
												<form id="kt_modal_new_target_form2" class="form" action="#">
													...
													<div class="mb-13 text-center">
														<!--begin::Title-->
														<h1 class="mb-3"><asp:Label ID="lblOptions" runat="server" Text="Task Details"></asp:Label> <asp:HiddenField ID="hid" runat="server" Value="0" /><asp:HiddenField ID="hcallid" runat="server" Value="0" /> </h1>
														<!--end::Title-->
													<%--	<!--begin::Description-->
    ...
    <div class="form-group row mb-6">
              ...
              <asp:TextBox ID="txtduedate" runat="server" SkinID="DateNew" placeholder="Due Date"></asp:TextBox>
				  <asp:LinkButton ID="btntaskserach" runat="server" SkinID="BtnLinkSearch" style="padding-top:20px" OnClick="btntaskserach_Click" />
                  </div>
        </div>
											</li>
										</ul>
										...
										<div class="my-0"  >
											...
											<asp:DropDownList ID="ddlSearchUsers" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlSearchUsers_SelectedIndexChanged" CssClass="form-select form-select-white form-select-sm w-150px select2-hidden-accessible" >
												
											</asp:DropDownList>
											<!--begin::Select-->
											<%--<select style="display:none; visibility:hidden;" name="status" data-control="select2" data-hide-search="true" class="form-select form-select-white form-select-sm w-150px select2-hidden-accessible" data-select2-id="select2-data-64-h81u" tabindex="-1" aria-hidden="true">
	...
	<div id="kt_project_targets_card_pane" class="tab-pane fade show active" data-select2-id="select2-data-kt_project_targets_card_pane" style="min-height:350px;">
										<!--begin::Row-->
          ...
          <ItemTemplate>
			  <div class="card mb-6 mb-xl-9">
												...
												<div class="d-flex">
													 <asp:Button ID="Button1" runat="server" SkinID="btnDefault" Text="Create New Target" style="width:100%;" OnClick="btnAddTarget_click" Visible="false"   />
												</div>
			...
			<script type="text/javascript">
                function pageLoad() {
                    ...
                    $(document).ready(function () {
                        ...
                        var myDropzone3 = new Dropzone(id, { // Make the whole body a dropzone
                        ...
                        myDropzone3.on("complete", function (progress) {
