...
{
    public partial class DCDashboardCtrl : System.Web.UI.UserControl
    {
        ...
        public void ExportData(string type)
        {
            try
            {
                ...
                using (DCDataContext db = new DCDataContext())
                {
                    ...
                    flsList = FLSDetailsBAL.Jqgridlist().OrderByDescending(j => j.CallID).ToList();
                    ...
                    using (DCDataContext Dc = new DCDataContext())
                    {
                        ...
                        var Result = (from a in FlsList
                                      ...
                                      select new
                                      {
                                          ...
                                          TicketRef = "" + a.CallID.Value.ToString(),
