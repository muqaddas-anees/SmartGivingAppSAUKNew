...
public partial class DC_controls_PermitToWorkHistory : System.Web.UI.UserControl
{
    public int CallID
    {
        get;
    ...
    public void DisplayHistory(int cid)
    {
        try
        {
            ...
            List<History> hList = ws.BindPermitToWorkHistory(cid);
            //callid = cid;
    ...
    protected void chk_visibility_CheckedChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            dw.PermitToWork_CustomerVisiblityUpdate(int.Parse(hid.Value), Convert.ToDateTime(h_date.Value), cb.Checked);
