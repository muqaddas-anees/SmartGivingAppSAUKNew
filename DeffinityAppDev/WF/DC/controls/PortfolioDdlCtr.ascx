<%@ Control Language="C#" AutoEventWireup="true" Inherits="controls_DC_PortfolioDdlCtr" Codebehind="PortfolioDdlCtr.ascx.cs" %>
...
<asp:Panel ID="Panel_portfolio" ClientIDMode="Static" runat="server" Width="70%">
    ...
    <div class="modal-header">
        <button ID="btnClose" runat="server" type="button" class="close" data-dismiss="modal" aria-hidden="true" style="display:none;">&times;</button>
        <asp:LinkButton ID="btnCloseNew" runat="server" CssClass="close" SkinID="BtnLinkClose" OnClick="btnCloseNew_Click" ToolTip=""></asp:LinkButton>
