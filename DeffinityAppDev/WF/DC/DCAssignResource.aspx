<%@ Page Title="" Language="C#" MasterPageFile="~/MasterTabSub.master" AutoEventWireup="true" CodeBehind="DCAssignResource.aspx.cs" Inherits="DeffinityAppDev.WF.DC.DCAssignResource" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetTotalEvents() {
            ...
            $.ajax({
                type: "POST",
                url: '../DC/Resourceservice.asmx/GetAllEvents',
...
<hr class="no-top-margin" />
     ...
     <div class="col-md-6 form-inline text-right">
         ...
         <asp:Button ID="btnAssign" runat="server" SkinID="btnDefault" Text="Assign To Ticket" OnClick="btnAssign_Click" />
         <asp:Button ID="btnEmailRequest" runat="server" SkinID="btnDefault" Text="Email Request" OnClick="btnEmailRequest_Click" Visible="false" />
                         <asp:Button ID="btnReopen" runat="server" SkinID="btnDefault" Text="Delete Resource and Reopen" OnClick="btnReopen_Click" />
                        </ContentTemplate>
              <Triggers>
