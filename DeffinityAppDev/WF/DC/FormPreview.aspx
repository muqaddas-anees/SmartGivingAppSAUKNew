<%@ Page Title="" Language="C#" MasterPageFile="~/WF/MainFrame.Master" AutoEventWireup="true" CodeBehind="FormPreview.aspx.cs" Inherits="DeffinityAppDev.WF.DC.FormPreview" %>
             ...
             function buildPanel() {
                 ...
                 $('[id*=ddlService] > option').each(function () {
                     if ($(this).val() != "0") {
                         ...
                         var pnlid = $(this).val();
                         b = b + "<div  id='pnl_" + pnlid + "' class='pnllistnew' style='display:grid'>";
                         b = b + "<div class='form-group'>";
                         b = b + "<div class='col-md-12' style='border-bottom: 2px solid #f5f5f5;padding-top: 20px;'>";
                         //  b = b + " <div class='col-sm-6 '></div>";
                         b = b + "<label class='col-sm-12 control-label lblpnl' style='width:100%'> <b>" + $(this).text(); +"</b> </label> ";
...
<script>
   ...
   <script type="text/javascript">
       ...
       $(window).load(function () {
           ...
           $('div[id^="pnl_"]').each(function () {
               //console.log(this.value);
              // $(this).css("display", "grid");
              //$(this).addClass('pnllistnew');  //pnllistnew
           });
           // Run code
           // alert('winload');
           // $("#pnl_50").css({ "border-style": "solid;", "border-color": "silver;", "margin": "15px;", "padding": "15px;", "display":"grid;" });
           // $("[id^='pnl_50']").css("background-color", "yellowgreen");
          // $("[id^='pnl_']").css("display", "grid");
           //$("[id^='pnl_50']").css("border-color", "silver");
           //$("[id^='pnl_50']").css("padding-bottom", "15px;");
           //$("[id^='pnl_50']").css("border-style", "solid");
          // $("[id^='pnl_']").addClass('pnllistnew');  //pnllistnew
