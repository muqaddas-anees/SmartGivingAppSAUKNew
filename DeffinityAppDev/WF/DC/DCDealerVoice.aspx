<%@ Page Title="" Language="C#" MasterPageFile="~/WF/MainTab.master" AutoEventWireup="true" Inherits="DCDealerVoice" Codebehind="DCDealerVoice.aspx.cs" %>

<%@ Register src="~/controls/MoveDealerVoice.ascx" tagname="DealerVoice" tagprefix="uc1" %>
  ...
  <tr>    
    ...
    <uc3:MoveTab ID="AssetsMoveTab1" runat="server" />  
     <div id="countrydivcontainer" style="border: 1px solid #d8dee5; margin-bottom: 1em;
                    padding: 10px"> 
<uc1:DealerVoice ID="DealerVoice1" runat="server" Type="FLS" />
</div>
 </td>
  </tr>
</table>
