<%@ Page Title="" Language="C#" MasterPageFile="~/WF/MainTab.master" AutoEventWireup="true" Inherits="DCDashboard" Codebehind="DCDashboard.aspx.cs" %>

<%@ Register src="~/controls/MoveDashboard.ascx" tagname="MoveDashboard" tagprefix="uc1" %>
  ...
  <tr>    
    ...
    <uc3:MoveTab ID="AssetsMoveTab1" runat="server" />  
     <div id="countrydivcontainer" style="border: 1px solid #d8dee5; margin-bottom: 1em;
                    padding: 10px"> 
<uc1:MoveDashboard ID="MoveDashboard1" runat="server" Type="FLS" />
</div>
 </td>
  </tr>
</table>
