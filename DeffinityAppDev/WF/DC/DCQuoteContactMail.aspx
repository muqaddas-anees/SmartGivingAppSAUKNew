<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DCQuoteContactMail.aspx.cs" Inherits="DeffinityAppDev.WF.DC.DCQuoteContactMail" %>
    ...
    <div class="card shadow-sm">
        ...
        <div class="panel-body">
          <%--  <uc1:CustomerOrder runat="server" ID="CustomerOrder" />--%>
             ...
             <asp:Label CssClass="galert galert-success" ID="lblMsg" runat="server" ></asp:Label>
