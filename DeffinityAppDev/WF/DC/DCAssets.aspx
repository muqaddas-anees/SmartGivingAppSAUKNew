<%@ Page Title="" Language="C#" MasterPageFile="~/WF/MainTab.master" AutoEventWireup="true" Inherits="DCAssets" Codebehind="DCAssets.aspx.cs" %>

<%@ Register src="~/controls/MoveAssets.ascx" tagname="MoveAsset" tagprefix="uc1" %>
  ...
  <tr>    
    ...
    <uc3:MoveTab ID="AssetsMoveTab1" runat="server" />  
     <div id="countrydivcontainer" style="border: 1px solid #d8dee5; margin-bottom: 1em;
                    padding: 10px"> 
<uc1:MoveAsset ID="MoveAssetsId" runat="server" Type="FLS" />
</div>
 </td>
  </tr>
</table>
