<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DCQuoteMail.aspx.cs" Inherits="DeffinityAppDev.WF.DC.DCQuoteMail" EnableEventValidation="false" %>

<%@ Register Src="~/WF/Controls/Footer.ascx" TagName="Footer" TagPrefix="uc1" %>
<%@ Register Src="~/WF/DC/controls/DCQuotationItemsDisplayCtrl.ascx" TagPrefix="uc1" TagName="sd_services" %>
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server" EnablePageMethods="true" LoadScriptsBeforeUI="true">
    ...
    <div class="card shadow-sm">
						<div class="card-header">
						  <label id="lblHeading" runat="server" style="font-size:30px">Your Quotation</label>  

                           
						</div>
        <div class="panel-body">
             <label id="lblTitle" runat="server" style="font-size:20px"></label>  
