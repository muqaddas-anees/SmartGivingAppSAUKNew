<%@ Control Language="C#" AutoEventWireup="true" Inherits="controls_ChitChatCtrlNewResource" Codebehind="ChitChatCtrlNewResource.ascx.cs" %>
...
<script type="text/javascript">
    ...
    function DisplayCommentBoxOpen(divNum, hrfIDValue) {
        ...
        var commentBox = ProfileImage + '<input id=\'' + txtCommentBoxID + '\'  /> <input class=\'btn btn-secondary\' id=\'btnComments\' title=\'Write a comment...\' value=\'Comment\' type=\'button\' onclick=\'OnComment_InsertClick(' + divNum + ',' + txtCommentBoxID + ',' + divNum + ',' + divIdNameSecond + ',' + hrfIDValue + ');\' />';
    ...
    function DisplayCommentBox(divNum, hrfIDValue) {
        ...
        var UserName = '<a href=\'' + strProfileLink + '\'' + '   onclick=' + strPop + '\'/>' + strUserName + '</a>';
        var ProfileImage = '<a class=\'xe-user-img\' href=\'' + strProfileLink + '\'' + '   onclick=' + strPop + '\'/><img class=\'img-circle\' width=\'40\' src=\'' + strProfileImg + '\' alt=\'' + strUserName + '\' /></a>';
    ...
    function getusertype() {
        ...
        //        var lbluserid = document.getElementById('<%=hid_usertype.ClientID%>').value;
        //        alert(lbluserid);
        //        if (lbluserid == "4" || lbluserid == "9") {
        //            //document.getElementById('div_input').style.visibility = 'hidden';
        //            retval = true;
        //        }
        //        else {
        //            //document.getElementById('div_input').style.visibility = 'visible';
        //            retval = true;
        //        }
        return true;
    }
    ...
    <div class="xe-widget xe-conversations" style="width:700px">    
      <div class="xe-bg-icon">
        ...
        <div class="xe-header">
            ...
            <div class="xe-label">
                <h3>
                    <%--<%= Resources.DeffinityRes.RecentChitChat%>--%><asp:HiddenField ID="hid_usertype" runat="server" /> 
     ...
     <div class="clr"></div>
        ...
        <div id="pnl1" runat="server" visible="false" >
               ...
               <input id="btnMainShare"  class='btn btn-secondary' title="<%$ Resources:DeffinityRes,Share%>" value="Share" runat="server"  type="button" onclick="OnMainShareText_InsertClick();"  />            
        ...
        <div class="clr">
            ...
            <div id="divAttachfileAndLink" class="attachment"  runat="server" visible="false">
               <h2><%= Resources.DeffinityRes.Attach%> &nbsp;</h2> <a  style="display: none;" href="javascript:AttachFile();"><img  src="media/file.gif" /></a><p><a  style="display: none;" href="javascript:AttachFile();" id="hrefAttach" runat="server"  >File</a></p>
                
               <a href="javascript:AttachLink();"  ><img  src="media/link.gif" /></a><p><a href="javascript:AttachLink();" id="A2" runat="server"  ><%= Resources.DeffinityRes.Link%></a></p>
            </div><div class="clr"></div>
            <div id="divAttach" style="display:none; border: 1px solid rgb(1, 1, 1); " runat="server" visible="false">                
               
                      <h2><div style="float:left"> <img style="float:left" alt="Attach a File" src="media/file.gif"  /><%= Resources.DeffinityRes.AttachaFile%> </div><a href="javascript:AttachFile();" id="A1"><img alt="Close the publisher" src="media/Cancel_chat.gif"  /></a></h2>
                    <div>
                        <ul>
                            <li > <label>&nbsp;</label><b>*</b><%= Resources.DeffinityRes.RequiredInformation%> </li>
                            <li>
                                <label>
                                  <%= Resources.DeffinityRes.Selectafile%>  </label><b>*</b>
                                <input type="file" id="txtfileUpload"   /></li>
                            <li>
                                <label>
                                   <%= Resources.DeffinityRes.Name%>  </label><b>*</b>
                                <input id="txtfileName"   /></li>
                            <li>
                                <label>
                                  <%= Resources.DeffinityRes.Description%>  </label><b>&nbsp;&nbsp;</b>
            ...
            <div id="divLink" style="display: none; border: 1px solid rgb(1, 1, 1);" runat="server" visible="false">
            
               <h2><div style="float:left"><img style="float:left" alt="Attach a Link" src="media/link.gif"    /><%= Resources.DeffinityRes.AttachaLink%>  </div>
                    <a href="javascript:AttachLink();" id="hrefAttachLinkClose"  >
                        <img alt="Close the publisher" src="media/Cancel_chat.gif"  /></a> </h2>
                <div>
                 <ul>
                   <li>  <label>&nbsp;</label><b>*</b> <%= Resources.DeffinityRes.RequiredInformation%><br /></li>
                <li>          <label>  <%= Resources.DeffinityRes.LinkURL%>    Link URL </label><b>*</b><br />
                <input id="txtLinkURL" value="http://"   /></li>
              
              <li> <label>  <%= Resources.DeffinityRes.LinkName%>  </label><b>*</b><br />
       
                <input id="txtLinkName" /></li>
                <li><label>&nbsp;</label><b>&nbsp;&nbsp;&nbsp;</b><input id="btnShareLink" title=" <%= Resources.DeffinityRes.ShareLink%>" value="Share Link" type="button" onclick="OnMainShareLink_InsertClick();"   /></li></ul>   
                </div>
