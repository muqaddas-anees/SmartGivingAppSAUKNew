<%@ Control Language="C#" AutoEventWireup="true" Inherits="MailControls_TimesheetProjectsub" Codebehind="TimesheetProjectsub.ascx.cs" %>
...
<tr>
    <td>
    <br />
<asp:Label ID="lblUserName" runat="server" ForeColor="Navy" Font-Bold="true"></asp:Label> has submitted a Timesheet for approval, for week commencing  <asp:Label ID="litapprovereject" runat="server" ForeColor="Navy" Font-Bold="true" Visible="false"></asp:Label>   <asp:Label ID="lblWCDate" runat="server" ForeColor="Navy" Font-Bold="true"></asp:Label>
