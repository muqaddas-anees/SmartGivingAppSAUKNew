...
public partial class _Default : System.Web.UI.Page 
{
    ...
    string[] Purl = { "", "~/WF/DC/DashboardV2.aspx", "~/WF/DC/DashboardV2.aspx", "~/WF/DC/DashboardV2.aspx", "~/WF/DC/FLSResourceList.aspx?type=FLS",
                        "~/WF/Projects/QA/QASummary.aspx", "", "~/WF/Portal/Home.aspx","~/WF/Vendors/RFIVendorSummary.aspx",
        ...
        try
        {
            ...
            if (retval > 0)
            {
                ...
                if(portfoliodata != null)
                {
                    ...
                    sessionKeys.IsService = portfoliodata.IsGroup.HasValue ? portfoliodata.IsGroup.Value : false;
