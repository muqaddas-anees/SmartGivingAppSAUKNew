<%@ Page Language="C#" AutoEventWireup="true" Theme="Theme1" Inherits="Reports_Default5" Codebehind="LiveProjects.aspx.cs" %>
	...
	<div>
        <table width="80%" border="0" cellspacing="0" cellpadding="0">
         <%--   <tr>
            ...
            <tr> 
               <td width="20%">&nbsp;&nbsp;&nbsp;<asp:Label ID="Label1" runat="server" Font-Names="Verdana" Font-Size="X-Small">Select&nbsp;Country</asp:Label></td>
                <td width="20%">&nbsp;&nbsp;&nbsp;<asp:DropDownList ID="ddlCountries" runat="server" Width="140px" CssClass="txt_field"> </asp:DropDownList></td>
                <td width="20%">&nbsp;&nbsp;&nbsp;<asp:ImageButton ID="btnReport" runat="server" OnClick="btnReport_Click"      AlternateText="Get Report" ImageUrl="~/images/btn_view_report.gif"/></td>
            </tr> 
