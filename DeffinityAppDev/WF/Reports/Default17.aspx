<%@ Page Language="C#" AutoEventWireup="true" Theme="Theme1" Inherits="Default17" Codebehind="Default17.aspx.cs" %>
...
<div class="sec_table1">
	<div>
        ...
        <tr>
        <td>Select Group Owner</td>
        <td><asp:DropDownList ID="ddlOwners" runat="server" Width="200px" Font-Names="Verdana">
        </asp:DropDownList></td>
        <td>
        Days
        </td>
