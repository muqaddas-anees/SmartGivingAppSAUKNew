<%@ Page Language="C#" AutoEventWireup="true" Inherits="Reports_ServiceRequestfaultReport" Codebehind="ServiceRequestfaultReport.aspx.cs" %>
    ...
    <form id="form1" runat="server">
      <div style="font-family:Verdana, Arial, Helvetica, sans-serif;font-size:13px">
            <table width="100%">
                ...
                <td width="160px">
                <asp:DropDownList ID="ddlmainCategory" runat="server" Width="160px" > 
                <asp:ListItem Value="All" Text="All">All</asp:ListItem>
                <asp:ListItem Value="Fault" Text="Fault">Fault</asp:ListItem>
                 <asp:ListItem Value="Service Request" Text="Service Request">Service Request</asp:ListItem>
