...
public partial class Reports_TimesheetSummaryComplete_ : System.Web.UI.Page
{
    ...
    protected void btn_Submitt_Click(object sender, EventArgs e)
    {
        try
        {
            TimesheetSummary.Attributes.Add("src", string.Format("Timesheetsummaryjournalcompletefrm.aspx?teamid={0}&resourceid={1}&sdate={2}&edate={3}&customer={4} &type=pdf", ddlTeam.SelectedValue, ddlcontractors.SelectedValue, txt_StartDate.Text.Trim(), txt_EndDate.Text.Trim(),ddlCustomers.SelectedValue));
    ...
    protected void LinkButton2_Click(object sender, EventArgs e)
    {
        try
        {
            TimesheetSummary.Attributes.Add("src", string.Format("Timesheetsummaryjournalcompletefrm.aspx?teamid={0}&resourceid={1}&sdate={2}&edate={3}&customer={4} &type=xsl", ddlTeam.SelectedValue, ddlcontractors.SelectedValue, txt_StartDate.Text.Trim(), txt_EndDate.Text.Trim(),ddlCustomers.SelectedValue));
    ...
    protected void LinkButton3_Click(object sender, EventArgs e)
    {
        try
        {
            TimesheetSummary.Attributes.Add("src", string.Format("Timesheetsummaryjournalcompletefrm.aspx?teamid={0}&resourceid={1}&sdate={2}&edate={3} &customer={4} &type=xsl1", ddlTeam.SelectedValue, ddlcontractors.SelectedValue, txt_StartDate.Text.Trim(), txt_EndDate.Text.Trim(),ddlCustomers.SelectedValue));
