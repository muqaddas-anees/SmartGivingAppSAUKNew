<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/WF/MainFrame.Master" 
        Inherits="Reports_TimeBookingforTask" Codebehind="TimeBookingforTask.aspx.cs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Title" runat="server">
    <asp:Label ID="lbl1" runat="server" Text="Task Time Booking Report" Font-Size="Large"></asp:Label>
</asp:Content>
              ...
              <div class="col-xs-8">
                  <div class="form-group">
                           <div class="col-xs-8">
                                ...
                                <div class="col-sm-9">
                                     <asp:DropDownList ID="ddlCustomers" runat="server" DataSourceID="SqlDataSourceTitle2" SkinID="ddl_70"
                    AutoPostBack="True" DataTextField="PortFolio" DataValueField="ID" OnSelectedIndexChanged="ddlCustomers_SelectedIndexChanged"></asp:DropDownList>
                           ...
                           <div class="col-xs-8">
                                ...
                                <div class="col-sm-9">
                                      <asp:DropDownList ID="ddlProejcts"  runat="server" AutoPostBack="True" SkinID="ddl_70"
                                                                 OnSelectedIndexChanged="ddlProejcts_SelectedIndexChanged" 
                                                                 ondatabound="ddlProejcts_DataBound"></asp:DropDownList>
                                </div>
                           </div>
                  </div>
                  <div class="form-group">
