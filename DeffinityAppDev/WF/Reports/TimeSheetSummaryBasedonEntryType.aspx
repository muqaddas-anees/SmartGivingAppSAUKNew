<%@ Page Language="C#" AutoEventWireup="true" Inherits="Reports_TimeSheetSummaryBasedonEntryType"
          MasterPageFile="~/WF/MainFrame.Master" Codebehind="TimeSheetSummaryBasedonEntryType.aspx.cs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Title" runat="server">
    <asp:Label ID="lbl1" runat="server" Text="Timesheet Summary Report" Font-Size="Large"></asp:Label>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-group">
      <div class="col-xs-4">
           ...
           <div class="col-sm-9">
                 <asp:DropDownList ID="ddlCustomers" SkinID="ddl_70" runat="server" DataTextField="PortFolio" DataValueField="ID" DataSourceID="SqlDataSourceTitle2" 
	...
	<div class="col-xs-4">
           ...
           <div class="col-sm-9">
                 <asp:DropDownList ID="ddlTeam" runat="server" SkinID="ddl_70" AutoPostBack="True"
