...
public partial class Reports_RPT_ShiftRotaMonthlyPage : System.Web.UI.Page
{
    ReportDocument rpt;
    ...
    protected void Page_Init(object sender, EventArgs e)
   {
    ...
    private void BindReport()
    {
        ...
        string str = "ShiftRotaMonthly.rpt";
        ...
        SqlCommand myCommand = new SqlCommand("DN_RPT_ShiftDetailsMonthly", MyCon);
        ...
        myCommand.Parameters.AddWithValue("Month", Convert.ToInt32(month));
        myCommand.Parameters.AddWithValue("Year", Convert.ToInt32(year));
        myCommand.Parameters.AddWithValue("PortfolioID", sessionKeys.PortfolioID);
