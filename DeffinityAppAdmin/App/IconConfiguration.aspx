...
<div class="card mt-4">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <div class="col-md-9 text-end">
            <asp:Button ID="btnAddLevel" runat="server" CssClass="btn btn-primary" 
                Text="Add Level" OnClientClick="$('#addLevelModal').modal('show'); return false;" />
        </div>
    </div>
    ...
    <div class="card-body">
        ...
        <div class="table-responsive mt-4">
            <asp:GridView ID="gvLevels" runat="server" CssClass="table table-bordered table-striped" 
                AutoGenerateColumns="False" OnRowCommand="gvLevels_RowCommand" DataKeyNames="Id">
                <Columns>
...
onclick='editLevel(<%# Eval("Id") %>, "<%# string.Format("{0:N0}", Eval("FromRange")) %>", "<%# string.Format("{0:N0}", Eval("ToRange")) %>", "<%# Eval("Country") %>")'>
                    ...
                    <asp:BoundField HeaderText="Lower Level"  DataFormatString="{0:N0}" DataField="FromRange">
                        <ItemStyle CssClass="right-align" />
                    </asp:BoundField>

                    <asp:BoundField HeaderText="Upper Level"  DataFormatString="{0:N0}" DataField="ToRange">
                        <ItemStyle CssClass="right-align" />
                    </asp:BoundField>
                    ...
                    <asp:TemplateField HeaderText="Delete">
                        <ItemTemplate>
                            <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="btn btn-sm btn-danger" 
                                CommandName="DeleteLevel" CommandArgument='<%# Eval("Id") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
...
<div class="form-group">
    ...
    <asp:TextBox ID="txtToRange" runat="server" CssClass="form-control" 
                 oninput="formatNumberWithCommas(this)"></asp:TextBox>
                     ...
                     <div class="form-group">
     <label for="txtToRange">Country</label>
     <asp:DropDownList ID="ddlCountry1" runat="server" CssClass="form-select">
    ...
    <script type="text/javascript">
        ...
        document.getElementById('<%= ddlCountry.ClientID %>').value = country;
