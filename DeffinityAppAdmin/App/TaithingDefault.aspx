<%@ Page Title="" Language="C#" MasterPageFile="~/MainTab.master" AutoEventWireup="true" CodeBehind="TaithingDefault.aspx.cs" Inherits="DeffinityAppDev.App.TaithingDefault" %>
    ...
    <div class="card mb-5 mb-xl-10">
								...
								<div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
									...
									<div class="card-title m-0">
										<h3 class="fw-bolder m-0">Digital Tithing</h3>
									</div>
											...
											<div class="row mb-6">
												...
												<div class="col-lg-8">
													<div class="row">
                                                        ...
                                                        <asp:ListItem Value="-1">Currency Type</asp:ListItem>
														...
														<!--begin::Col-->
														<div class="col-lg-6 fv-row fv-plugins-icon-container">
															<asp:TextBox ID="txtcurrenyValue" runat="server" Text="0.00" ToolTip="Amount" ></asp:TextBox>
														<div class="fv-plugins-message-container invalid-feedback"></div></div>
														<!--end::Col-->
													</div>
												</div>
