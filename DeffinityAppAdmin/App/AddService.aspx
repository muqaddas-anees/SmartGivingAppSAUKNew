...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="card">
        ...
        <div class="row mb-6">
            ...
            <div class="col-md-2">
                <asp:TextBox ID="txtPriceSmallCharity" runat="server" CssClass="form-control" Text="Monthly Price for Small Charities"></asp:TextBox>
            </div>
            <div class="col-md-1"></div>
            <div class="col-md-3">
                <asp:TextBox ID="txtBuyNowSmallCharity" runat="server" CssClass="form-control" Text="Buy Now URL for Small Charities"></asp:TextBox>
            </div>
        </div>
...
<asp:ListItem Text="ZAR" Value="ZAR"></asp:ListItem>
            ...
            <div class="col-md-2">
                <asp:TextBox ID="txtPriceMediumCharity" runat="server" CssClass="form-control" Text="Monthly Price for Medium Charities"></asp:TextBox>
            </div>
            <div class="col-md-1"></div>
      
           <div class="col-md-4" align="left">
    <div class="form-group d-flex align-items-center">
        <label class="me-2 mb-0" style="white-space: nowrap;"><h4>Monthly Subscription Link</h4> </label>
        <asp:TextBox ID="txtBuyNowMediumCharity" runat="server" CssClass="form-control" Text="Buy Now URL for Medium Charities"></asp:TextBox>
    </div>
</div>
        </div>
