<%@ Page Title="" Language="C#" MasterPageFile="~/MainTab.master" AutoEventWireup="true" CodeBehind="Contacts.aspx.cs" Inherits="DeffinityAppDev.App.Contacts" EnableEventValidation="false" %>
...
<%--    <link href="../assets/plugins/global/plugins.bundle.css" rel="stylesheet" />
    ...
    <div class="card mb-5 mb-xl-10" id="pnlGrid" runat="server">
								...
								<div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
									...
									<div class="card-title m-0">
										<h3 class="fw-bolder m-0">Contacts</h3>
									</div>
        ...
        <Columns>
              <asp:TemplateField ItemStyle-Width="9px">
                                                    <ItemTemplate>
														...
														<a href='Contacts.aspx?orgid=<%# Eval("OrgID") %>&eid=<%# Eval("ID") %>' class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
           ...
           <%--  <asp:TemplateField ItemStyle-Width="50px" >
             ...
             <asp:TemplateField HeaderText="Email" SortExpression="Email">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblAddress" runat="server" Text='<%# Bind("Email") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
             <asp:TemplateField HeaderText="Mobile" SortExpression="Mobile">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblReligion" runat="server" Text='<%# Bind("Mobile") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
            <asp:TemplateField HeaderText="Address" SortExpression="Address1">
                                                    ...
                                                    <ItemStyle Width="25%" />
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblDenomination" runat="server" Text='<%# Bind("Address1") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
             ...
             <asp:TemplateField HeaderText="Town" SortExpression="Town">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblContact" runat="server"  Text='<%# Bind("Town") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
   ...
   <%--  <ajaxToolkit:ModalPopupExtender ID="mdlManageOptions" runat="server" BackgroundCssClass="modalBackground"
    TargetControlID="btnAddOptions" PopupControlID="pnlAddReligion" CancelControlID="btnClose" >
	 ...
	 <div class="card mb-5 mb-xl-10" ID="pnlAddContact" style="background-color:white" runat="server">
								<!--begin::Card header-->
								<div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
									<!--begin::Card title-->
									<div class="card-title m-0">
										<h3 class="fw-bolder m-0"><asp:Literal ID="lblAddContact" runat="server" Text="Add Contact"></asp:Literal> </h3>
									</div>
       	...
       	<div class="row mb-6">
												...
												<!--begin::Col-->
												<div class="col-lg-8">
													<asp:TextBox ID="txtMobile" runat="server" MaxLength="500"></asp:TextBox>
												</div>
												<!--end::Col-->
											</div>
											<!--end::Input group-->
