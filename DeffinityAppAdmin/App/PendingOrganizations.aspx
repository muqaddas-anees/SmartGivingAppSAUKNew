<%@ Page Title="" Language="C#" MasterPageFile="~/MainTab.master" AutoEventWireup="true" CodeBehind="PendingOrganizations.aspx.cs" Inherits="DeffinityAppDev.App.PendingOrganizations" %>
										...
										<div class="card-body border-top p-9">
                                         ...
                                         <div class="row">
											...
											<div class="row mb-6">
                                                <div class="row mb-3">
                                                     <div class="col-lg-12">
                                                    <asp:Button ID="btnSendMail" runat="server" Text="Send Email To Selected Charities" CssClass="btn btn-secondary" OnClick="btnSendMail_Click" />
                                                         </div>
                                                    </div>
        ...
        <Columns>
               <asp:TemplateField ItemStyle-Width="9px" >
                                                    <ItemTemplate>
                                                         ...
                                                         <asp:Label ID="lblID" runat="server" Width="40px" Text='<%# Bind("ID") %>' Visible="false"></asp:Label>
...
<br />                                                        
              ...
              <asp:TemplateField HeaderText="Date Uploaded" SortExpression="DateUploaded">
                                                    <HeaderStyle />
                                                    <ItemStyle Width="8%" />
                                                    <ItemTemplate>
            ...
            <asp:TemplateField >
               ...
               <asp:TemplateField >
                  <ItemStyle Width="5%" />
                                                    <ItemTemplate>
                                                        <asp:Button ID="btnMID" runat="server" Text="Send Email" CommandName="email" CommandArgument='<%# Bind("ID") %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
    ...
    TargetControlID="btnUpload" PopupControlID="pnlAddReligion" CancelControlID="lbl_close_this" >
</ajaxToolkit:ModalPopupExtender>
     <asp:Label ID="btnAddOptions" runat="server"></asp:Label>
        <asp:Label ID="lbl_lbtnClosePassword" runat="server"></asp:Label>
     <asp:Label ID="lbl_close_this" runat="server"></asp:Label>
