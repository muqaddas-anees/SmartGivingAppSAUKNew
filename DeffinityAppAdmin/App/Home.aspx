...
<div class="col-xl-3">
    ...
    <!--end::Statistics Widget 5-->
      ...
      <div class="col-xl-3">
    <!--begin::Statistics Widget 5-->
    <a href="EventScroller.aspx" class="card hoverable card-xl-stretch mb-xl-8" style="border: 2px solid #7239EA; background-color: transparent;">
        <!--begin::Body-->
        <div class="card-body text-center">
            <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm002.svg-->
            <span class="svg-icon svg-icon-white svg-icon-3x ms-n1" style="color: #7239EA;">
            ...
            <!--end::Svg Icon-->
            <div class="fw-bolder" style="color: #7239EA; font-size: 2rem; margin-top: 1rem;">Event Scroller</div>
            <div class="fw-bold fs-7" style="color: #7239EA !important;"></div>
        </div>
        <!--end::Body-->
    </a>
...
<div class="col-xl-3">
    ...
    <a href="TransactionReport.aspx" class="card card-xl-stretch mb-xl-8 hoverable" style="border: 2px solid #7239EA; background-color: transparent;">
        ...
        <div class="card-body text-center">
            ...
            <!--end::Svg Icon-->
            <div class="fw-bolder" style="color: #7239EA;font-size: 2em;margin-top: 1rem;">Transaction Report</div>
            <div class="fw-bold fs-7" style="color: #7239EA;"></div>
        </div>
        <!--end::Body-->
    </a>
...
<div class="col-xl-3">
    ...
    <a href="CharityChampions.aspx" class="card card-xl-stretch mb-xl-8 hoverable" style="border: 2px solid #7239EA; background-color: transparent;">
        ...
        <div class="card-body text-center">
            ...
            <!--end::Svg Icon-->
            <div class="fw-bolder" style="color: #7239EA;font-size: 2em;margin-top: 1rem;">Charity Champions</div>
            <div class="fw-bold fs-7" style="color: #7239EA;"></div>
        </div>
        <!--end::Body-->
    </a>
...
<div class="col-xl-3">
    ...
    <a href="ProfitReport.aspx" class="card card-xl-stretch mb-xl-8 hoverable" style="border: 2px solid #7239EA; background-color: transparent;">
        ...
        <div class="card-body text-center">
            ...
            <!--end::Svg Icon-->
            <div class="fw-bolder" style="color: #7239EA;font-size: 2em;margin-top: 1rem;">Profit Report</div>
            <div class="fw-bold fs-7" style="color: #7239EA;"></div>
        </div>
        <!--end::Body-->
    </a>
...
<div class="col-xl-3">
    ...
    <a href="VideosConfig.aspx" class="card card-xl-stretch mb-xl-8 hoverable" style="border: 2px solid #7239EA; background-color: transparent;">
        ...
        <div class="card-body text-center">
            ...
            <!--end::Svg Icon-->
            <div class="fw-bolder" style="color: #7239EA;font-size: 2em;margin-top: 1rem;">Videos</div>
            <div class="fw-bold fs-7" style="color: #7239EA;"></div>
        </div>
        <!--end::Body-->
    </a>
    ...
    <a href="Wordpress.aspx" class="card card-xl-stretch mb-5 mb-xl-8 hoverable" style="border: 2px solid #7239EA; background-color: transparent;">
        ...
        <div class="card-body text-center">
            ...
            <!--end::Svg Icon-->
            <div class="fw-bolder" style="color: #7239EA;font-size: 2em;margin-top: 1rem;;">WordPress</div>
            <div class="fw-bold fs-7" style="color: #7239EA;"></div>
        </div>
        <!--end::Body-->
    </a>
    ...
    <a href="Marketplace.aspx" class="card card-xl-stretch mb-5 mb-xl-8 hoverable" style="border: 2px solid #7239EA; background-color: transparent;">
        ...
        <div class="card-body text-center">
            ...
            <!--end::Svg Icon-->
            <div class="fw-bolder" style="color: #7239EA;font-size: 2em;margin-top: 1rem;;">Marketplace</div>
            <div class="fw-bold fs-7" style="color: #7239EA;"></div>
        </div>
        <!--end::Body-->
    </a>
    ...
    <a href="Iconconfiguration.aspx" class="card card-xl-stretch mb-5 mb-xl-8 hoverable" style="border: 2px solid #7239EA; background-color: transparent;">
        ...
        <div class="card-body text-center">
            ...
            <!--end::Svg Icon-->
            <div class="fw-bolder" style="color: #7239EA;font-size: 2em;margin-top: 1rem;;">Icon Configuration</div>
            <div class="fw-bold fs-7" style="color: #7239EA;"></div>
        </div>
        <!--end::Body-->
    </a>
    <!--end::Statistics Widget 5-->
                		...
                		<div class="col-xl-3">
    <!--begin::Statistics Widget 5-->
    <a href="feedback.aspx" class="card card-xl-stretch mb-5 mb-xl-8 hoverable" style="border: 2px solid #7239EA; background-color: transparent;">
        <!--begin::Body-->
        <div class="card-body text-center">
            <!--begin::Svg Icon-->
            <span class="svg-icon svg-icon-3x">
                <i class="bi bi-lightbulb" style="color: #7239EA; height:39px;width:39px;font-size:39px"></i>
            </span>
            <!--end::Svg Icon-->
            <div class="fw-bolder" style="color: #7239EA;font-size: 2em;margin-top: 1rem;">Feedback </div>
            <div class="fw-bold fs-7" style="color: #7239EA;"></div>
        </div>
        <!--end::Body-->
    </a>
