                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0 dataTable no-footer" id="kt_permissions_table">
                            <thead>
                                <tr class="text-start text-gray-800 fw-bold fs-7 text-uppercase gs-0">
                                    <th class="min-w-125px sorting text-center" tabindex="0" aria-controls="kt_permissions_table" rowspan="1" colspan="1" aria-label="Name: activate to sort column ascending" style="width: 200px;">Name</th>
                                    <th class="min-w-125px sorting_disabled text-center" rowspan="1" colspan="1" aria-label="Assigned to" style="width: 250px;">Assigned to</th>
                                    <th class="text-end min-w-125px sorting_disabled text-center" rowspan="1" colspan="1" aria-label="Actions" style="width: 200px;">Role</th>
                                                                        <th class="min-w-125px sorting text-center" tabindex="0" aria-controls="kt_permissions_table" rowspan="1" colspan="1" aria-label="Created Date: activate to sort column ascending" style="width: 200px;">Created Date</th>
