...
{
	public partial class OrganizationAdmin1 : System.Web.UI.Page
	{
        ...
        void BindGrid()
        {
            var uList = PortfolioTrackerLoginBAL.PortfolioTrackerLoginBAL_SelectAll().Where(o=>o.PartnerID ==1).ToList();
        ...
        protected void btnSubmit_onclick(object sender, EventArgs e)
		{
            ...
            try
            {
                ...
                {
                    AddUser(txtUsername1.Text.Trim(), txtEmail1.Text.Trim(), txtPassword1.Text.Trim(), 1);
