...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="card-header border-0 cursor-pointer" role="button"  aria-expanded="true" aria-controls="kt_account_profile_details">
        ...
        <div class="card-toolbar">
            <asp:LinkButton ID="btnSaveSettings" style="margin-right:10px" OnClientClick="return ClearValues()" OnClick="btnsave_Click1" runat="server" CssClass="btn btn-primary">Save</asp:LinkButton>
