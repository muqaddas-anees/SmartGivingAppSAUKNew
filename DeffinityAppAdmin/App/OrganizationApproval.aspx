<%@ Page Title="" Language="C#" MasterPageFile="~/MainTab.master" AutoEventWireup="true" CodeBehind="OrganizationApproval.aspx.cs" Inherits="DeffinityAppDev.App.OrganizationApproval" %>
    ...
    <div class="card mb-5 mb-xl-10">
								...
								<div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
									...
									<div class="card-title m-0">
                                     ...
                                     <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="" data-bs-original-title="Click to add a user">
                                        <asp:Button Visible="false" ID="btnUpload" runat="server" CssClass="btn btn-bg-light" Text="Upload Organizations" OnClick="btnUpload_Click" style="margin-right:10px"   />  <asp:Button Visible="false" ID="btnAddOrganization" runat="server" CssClass="btn btn-primary" Text="Add New Organization" OnClick="btnAddOrganization_Click"  />
                                         </div>
									<!--end::Card title-->
								</div>
								<!--begin::Card header-->
									...
									<form id="kt_account_profile_details_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
										...
										<div class="card-body border-top p-9">
                                         ...
                                         <div class="row">
											...
											<!--begin::Input group-->
                                                  <div class="row mb-6">
                                                       <div class="col-lg-10 fv-row fv-plugins-icon-container form-inline">

                                                           </div>
                                                       <div class="col-lg-2 fv-row fv-plugins-icon-container form-inline">
                                                      <asp:Button ID="btnApprove" runat="server" SkinID="btnDefault" Text="Update" style="float:right;" />
                                                           </div>
                                                      </div>
											<div class="row mb-6">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Denomination" SortExpression="Denomination">
             ...
             <asp:TemplateField HeaderText="Administrator" SortExpression="Contact">
                                                    <HeaderStyle />
