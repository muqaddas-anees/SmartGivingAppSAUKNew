<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InventoryNew.ascx.cs"
...
<script language="javascript" type="text/javascript">
            ...
            function expandcollapseInnerGrid(obj, productid, Cid, row) {
                   ...
                   <div class="form-group">
                      ...
                      <div class="col-md-4">
                          <div class="col-sm-12">
                              ...
                              <asp:Button ID="btnGetReport" runat="server" Text="SUMMARY REPORT" SkinID="btnDefault" OnClick="btnGetReport_Click" />
                              <asp:Button ID="reportspan" ClientIDMode="Static" Text="Report" Visible="false" runat="server" SkinID="btnDefault" ></asp:Button>
                          </div>
                      </div>
                 </div>
                      ...
                      <div class="col-md-4">
                            ...
                            <div class="col-sm-8 form-inline">
                                 ...
                                 <ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtFromDeployedDate"
                                           Format="dd/MM/yyyy" CssClass="MyCalendar" PopupButtonID="imgFromDeployedDate"></ajaxToolkit:CalendarExtender>
                      ...
                      <div class="col-md-4">
                            ...
                            <div class="col-sm-8 form-inline">
                                 ...
                                 <ajaxToolkit:CalendarExtender ID="CalendarExtender3" runat="server" TargetControlID="txtToDeployedDate"
                                          Format="dd/MM/yyyy" CssClass="MyCalendar" PopupButtonID="imgToDeployedDate"></ajaxToolkit:CalendarExtender>
                                ...
                                Visible="False" SkinID="BtnLinkCancel"></asp:LinkButton>
                                  ...
                                  <div class="col-sm-8 form-inline">
                                      ...
                                      <ajaxToolkit:CalendarExtender ID="ClndrExtDateOrdered" runat="server" TargetControlID="txtDateOrdered"
                                                                Format="dd/MM/yyyy" CssClass="MyCalendar" PopupButtonID="imgOrderDate"></ajaxToolkit:CalendarExtender>
                                  ...
                                  <div class="col-sm-8 form-inline">
                                        ...
                                        <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtArrivalDate"
                                                                   Format="dd/MM/yyyy" CssClass="MyCalendar" PopupButtonID="imgArrivalDate"></ajaxToolkit:CalendarExtender>
...
<asp:Panel ID="pnlInventory" runat="server" ClientIDMode="Static" Width="100%">
                        ...
                        <asp:HiddenField ID="hfSubcatID" runat="server" Value="0" />
                                  <div style="float:right;text-align:right;margin-bottom:3px;">
                                      <asp:LinkButton ID="btnViewAll" runat="server" Visible="false" 
                        ...
                        <asp:GridView ID="grdInventory" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                         <a id="imageColapse" href="javascript:expandcollapseInnerGrid('divInner<%# Eval("id") %>','<%# Eval("id") %>','<%# Eval("Cid") %>','one');">
                                              <img title='View Usage' id='imgdivUsage<%# Eval("id") %>' alt='Click to show/hide <%# Eval("id") %>' style="width:9px;border:0px" src='plus.gif' />
                                        </a>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="<%$ Resources:DeffinityRes,Edit%>" Visible="false">
                                    <ItemStyle HorizontalAlign="Center" />
                                    <ItemTemplate>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            <td colspan="100%" style="padding:0px">
                                                   <div id='divInner<%# Eval("id") %>' style="display:none; position: relative; left: 15px;padding-bottom:5px;padding-top:15px;overflow: auto; width: 97%">
                                                       <asp:GridView ID="InnerGridHistory" runat="server" AutoGenerateColumns="False" GridLines="None"
                                                                     ShowHeaderWhenEmpty="true" HorizontalAlign="Left" BorderStyle="None" CellPadding="2"
                                                                     CellSpacing="2" EmptyDataText="No histoy found!" Width="100%">
                                                                     <Columns>
                                                                     <asp:BoundField DataField="ItemDescription" Visible="false" HeaderText="<%$ Resources:DeffinityRes,Product%>" />
                                                                     <asp:BoundField DataField="OpeningStock" HeaderText="<%$ Resources:DeffinityRes,OpeningStock%>" ItemStyle-HorizontalAlign="Right" />
                                                                     <asp:BoundField DataField="NoDeployed" HeaderText="<%$ Resources:DeffinityRes,QtyDeployed%>" ItemStyle-HorizontalAlign="Right" />  
                                                                     <asp:BoundField DataField="UseCode" HeaderText="<%$ Resources:DeffinityRes,UseCode%>"  />
                                                                     <asp:BoundField DataField="ReasonCode" HeaderText="<%$ Resources:DeffinityRes,ReasonCode%>" />
                                                       ...
                                                       <br />
                                                      <%-- <asp:GridView ID="GridSites" runat="server"></asp:GridView>--%>
                                                   </div>
