...
public partial class CheckPoint : System.Web.UI.Page
{
    ...
    private void BindReport()
    {
        ...
        string str = "CheckPointReport.rpt";
        rpt.Load(Server.MapPath(str));

        //Set the Database Login Information  Tasks.rpt
        ...
        SqlDataAdapter adp_sub1 = new SqlDataAdapter("DN_rpt_ProjectDetails", MyCon);
        ...
        SqlDataAdapter adp_sub = new SqlDataAdapter("DN_OutstandingTasksReport", MyCon);
        ...
        adp_sub.SelectCommand.Parameters.Add("@ContractorID", SqlDbType.Int).Value = Convert.ToInt32(Session["UID"]);
        adp_sub.Fill(dt1);
        ...
        SqlDataAdapter adp_sub2 = new SqlDataAdapter("DN_getTotals1", MyCon);
        ...
        SqlDataAdapter adp_sub3 = new SqlDataAdapter("DN_ProjectRisk4", MyCon);
        ...
        SqlDataAdapter adp_sub4 = new SqlDataAdapter("DN_ProjectQAScheduleReport", MyCon);
        ...
        SqlDataAdapter adp_sub5 = new SqlDataAdapter("DN_ProjectRecommendations", MyCon);
        ...
        SqlDataAdapter adp_sub6 = new SqlDataAdapter("DN_VarianceReport", MyCon);
        adp_sub6.SelectCommand.CommandType = CommandType.StoredProcedure;
        adp_sub6.SelectCommand.Parameters.Add("@ProjectReference", SqlDbType.Int).Value = ProjectReference;
        // adp_sub6.SelectCommand.Parameters.Add("@ContractorID", SqlDbType.Int).Value = ProjectReference;
        adp_sub6.Fill(dt7);
        rpt.Subreports[6].SetDatabaseLogon(strUser, strPassword, strServer, strDatabase);
        rpt.Subreports[6].SetDataSource(dt7);
