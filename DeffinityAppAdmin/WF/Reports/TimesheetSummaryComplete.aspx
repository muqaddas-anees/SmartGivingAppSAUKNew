<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/WF/MainFrame.Master" 
        Inherits="Reports_TimesheetSummaryComplete_" Codebehind="TimesheetSummaryComplete.aspx.cs" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Title" runat="server">
    <asp:Label ID="L1" runat="server" Text="Timesheet Summary - Complete Journal  Report" Font-Size="Large"></asp:Label>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <asp:ValidationSummary ID="V1" runat="server" ValidationGroup="one" />
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ControlToValidate="txt_StartDate"
                        Display="None" ErrorMessage="Please enter valid date in date field" 
    ...
    <div id="div1">
       <div class="form-group">
        <div class="col-xs-4">
           ...
           <div class="col-sm-9">
                 <asp:DropDownList ID="ddlCustomers" Width="150px" runat="server" 
    ...
    <div class="form-group">
          <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="updatepanel1">
                  <ProgressTemplate>
                          <asp:Label ID="LblLaoading" runat="server" SkinID="Loading"></asp:Label>
                  </ProgressTemplate>
          </asp:UpdateProgress> 
