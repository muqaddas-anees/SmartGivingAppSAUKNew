...
public partial class TimeSheetReport : System.Web.UI.Page
{
    ...
    private void Bindparameters()
    {
        ...
        string str = "TimeSheetReport.rpt";
        rpt.Load(Server.MapPath(str));
        DataTable dt = new DataTable();
        string strConn = System.Configuration.ConfigurationManager.AppSettings["DBString"];
        SqlConnection MyCon = new SqlConnection(strConn);
        SqlCommand MyCommand = new SqlCommand("DN_ReportTimeSheet", MyCon);
        MyCommand.CommandType = CommandType.StoredProcedure;
        MyCommand.Parameters.Add("@Project", SqlDbType.Int).Value = Project;
