...
public partial class Reports_SRRptSubCatagoy : System.Web.UI.Page
{
    ReportDocument rpt;
    ...
    private void BindReport()
    {
        ...
        SqlCommand myCommand = new SqlCommand("DN_SRBySubCat", MyCon);
        ...
        rpt.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "Service category");
