...
public partial class Reports_Default17 : System.Web.UI.Page
{
    ReportDocument rpt;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            //WebUserControl1.setSelection = 11;
   ...
   */
    ...
    private void BindReport()
    {
        ...
        SqlCommand myCommand = new SqlCommand("AMPS_CostVarienceByGroupOwner", MyCon);
