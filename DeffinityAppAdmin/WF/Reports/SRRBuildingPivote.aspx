<%@ Page Language="C#" AutoEventWireup="true" Inherits="Reports_SRRBuildingPivote" Codebehind="SRRBuildingPivote.aspx.cs" %>
    ...
    <div style="font-family:Verdana, Arial, Helvetica, sans-serif;font-size:13px">
            <table width="100%">
                ...
                <asp:DropDownList ID="ddlmainCategory" runat="server" Width="160px"  DataSourceID="DDLCustomer"
                                        ...
                                        SelectCommand="DN_SRRCatagoryName" SelectCommandType="StoredProcedure">
