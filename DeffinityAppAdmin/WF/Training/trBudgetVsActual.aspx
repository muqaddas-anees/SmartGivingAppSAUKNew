<%@ Page Title="" Language="C#" MasterPageFile="~/WF/MainTab.master" AutoEventWireup="true" Inherits="Training_trBudgetVsActual"
     Codebehind="trBudgetVsActual.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="form-group">
        <div class="col-xs-6">
              <label id="lblDepartment" class="col-sm-3 control-label"><%= Resources.DeffinityRes.Department%></label>
             <div class="col-sm-9">
       ...
       <div class="col-xs-6">
            <label id="Label1" class="col-sm-3 control-label"><%= Resources.DeffinityRes.Area%></label>
             <div class="col-sm-9">
                 <asp:DropDownList ID="ddlArea" runat="server" SkinID="ddl_70" 
       ...
       <label class="col-sm-3 control-label"><%= Resources.DeffinityRes.FromDate%></label>
             <div class="col-sm-9 form-inline">
                ...
                TargetControlID="txtFromDate" PopupButtonID="imgFromDate" runat="server">
                    ...
                    ControlToValidate="txtFromDate" ValidationGroup="Group4" ValidationExpression="(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\d\d"
        ...
        <div class="col-xs-6">
             ...
             <div class="col-sm-7 form-inline">
                ...
                TargetControlID="txtToDate" PopupButtonID="imgToDate" runat="server">
                    ...
                    ControlToValidate="txtToDate" ValidationGroup="Group4" ValidationExpression="(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\d\d"
                         Display="None"></asp:RegularExpressionValidator>
              <asp:CompareValidator ID="CompareValidator4" runat="server" Display="None" ControlToCompare="txtFromDate"
                ErrorMessage="To date should be greater than from date" Type="Date" ControlToValidate="txtToDate" Operator="GreaterThan"
                   ValidationGroup="Group4"></asp:CompareValidator>
    ...
    <igchart:UltraChart ID="UltraChart1" runat="server" 
        Version="7.2" Width="750px" Height="400px" BorderColor="#E0E0E0" 
        BorderWidth="0px" ChartImagesPath="~/ChartImages">
...
<TitleTop FontColor="Gray" FontSizeBestFit="True">
        ...
        <Border CornerRadius="10" Color="224,224,224" Raised="true" Thickness="0" />
...
<Effects><Effects>
    <igchartprop:GradientEffect></igchartprop:GradientEffect>
        ...
        <Legend BackgroundColor="White" BorderThickness="0" Location="Bottom" 
            SpanPercentage="15" Visible="True" FontColor="Gray" Font="Verdana, 7pt">
            <Margins Bottom="10" Left="150" Right="10" Top="0" />
            </Legend>
