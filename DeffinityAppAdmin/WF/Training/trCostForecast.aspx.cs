...
public partial class Training_trCostForecast : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            lblTitle.InnerText = "Training Cost Forecast";
   ...
   #region BindData
    private void BindChart()
    {
        try
        {
            ...
            UltraChart1.TitleTop.Text = "Forecast for Department :" + ddlDepartment.SelectedItem.ToString() + " Area :" + area;
            ...
            System.Data.DataTable dt = Bookings.Booking_CostForecast(int.Parse(ddlDepartment.SelectedValue), int.Parse(string.IsNullOrEmpty(ddlArea.SelectedValue) ? "0" : ddlArea.SelectedValue),
                       Convert.ToDateTime(string.IsNullOrEmpty(txtFromDate.Text) ? "1/1/1900" : txtFromDate.Text), Convert.ToDateTime(string.IsNullOrEmpty(txtToDate.Text) ? "1/1/1900" : txtToDate.Text));
            if (dt.Rows.Count == 0)
            {
            ...
            else
            {
                ...
                //cta.Row = -2;
                //cta.Column = -2;
                //cta.FontColor = System.Drawing.Color.Black;
