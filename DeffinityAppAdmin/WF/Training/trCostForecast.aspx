<%@ Page Title="" Language="C#" MasterPageFile="~/WF/MainTab.master" AutoEventWireup="true" Inherits="Training_trCostForecast" Codebehind="trCostForecast.aspx.cs" %>
     ...
     <div  class="form-group">
       <div class="col-xs-6">
           ...
           <div class="col-xs-6">
             ...
             <div class="col-sm-9">
                  <asp:DropDownList ID="ddlArea" runat="server" SkinID="ddl_70" onselectedindexchanged="ddlArea_SelectedIndexChanged"></asp:DropDownList>
             </div>
       </div>
     </div>
      <div  class="form-group">
       <div class="col-xs-6">
             <label id="Label4" runat="server" class="col-sm-3 control-label"><%= Resources.DeffinityRes.FromDate%></label>
           ...
           <div class="col-xs-6">
             <label id="Label5" runat="server" class="col-sm-3 control-label"><%= Resources.DeffinityRes.ToDate%></label>
             <div class="col-sm-9 form-inline">
              ...
              <asp:CompareValidator ID="CompareValidator4" runat="server" Display="None" ControlToCompare="txtFromDate"
                ErrorMessage="To date should be greater than from date" Type="Date" ControlToValidate="txtToDate" Operator="GreaterThan"
                   ...
                   <asp:Button ID="btnView" runat="server" Text="View" SkinID="btnDefault" ValidationGroup="Group4" onclick="btnView_Click" />
             </div>
       </div>
     </div>
    <div  class="form-group">
     ...
     <div  class="form-group">
            <igchart:UltraChart ID="UltraChart1" runat="server" Version="7.2" Width="750px" Height="400px" 
               BorderColor="#E0E0E0" BorderWidth="0px">
<Axis>
...
<TitleTop FontColor="Gray" FontSizeBestFit="True">
                ...
                <Border Color="224, 224, 224" CornerRadius="10" Raised="True" Thickness="0" />
...
<igchartprop:GradientEffect></igchartprop:GradientEffect>
                ...
                <Legend Location="Bottom" SpanPercentage="15" Visible="True" 
                    BackgroundColor="White" BorderThickness="0" Font="Verdana, 7pt" FontColor="Gray">
